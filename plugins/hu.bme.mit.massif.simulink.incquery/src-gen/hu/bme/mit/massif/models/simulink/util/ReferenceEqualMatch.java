...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.util.referenceEqual pattern,
...
public abstract class ReferenceEqualMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("sourceRef".equals(parameterName) ) {
    	this.fSourceRef = (hu.bme.mit.massif.simulink.SimulinkReference) newValue;
    	return true;
    }
    if ("targetRef".equals(parameterName) ) {
    	this.fTargetRef = (hu.bme.mit.massif.simulink.SimulinkReference) newValue;
    	return true;
    }
    return false;
  }
