...
@Path("/simu/{serviceProviderId}/busCreatorResources")
public class BusCreatorResourceService {
    @Context
    ...
    public BusCreatorResourceService() {
        super();
    }
    ...
    public BusCreatorResource[] getBusCreatorResources(@PathParam("serviceProviderId") final String serviceProviderId,
        ...
        final List<BusCreatorResource> resources = SimulinkAdaptorManager.getBusCreatorResources(httpServletRequest,
                serviceProviderId, page, limit);
        return resources.toArray(new BusCreatorResource[resources.size()]);
    ...
    public Response getBusCreatorResourcesAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
        ...
        if (resources != null) {
            ...
            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/buscreatorresourcecollection_html.jsp");
    ...
    @Path("{busCreatorId}")
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public BusCreatorResource getBusCreatorResource(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("busCreatorId") final String busCreatorId) throws IOException, ServletException,
            URISyntaxException {
        // Start of user code (MUST_FILL_IN) getResource_init
        // End of user code

        final BusCreatorResource aBusCreatorResource = SimulinkAdaptorManager.getBusCreatorResource(httpServletRequest,
                serviceProviderId, busCreatorId);

        if (aBusCreatorResource != null) {
    ...
    @Path("{busCreatorId}")
    @Produces({ MediaType.TEXT_HTML })
    public Response getBusCreatorResourceAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("busCreatorId") final String busCreatorId) throws ServletException, IOException,
            URISyntaxException {
        ...
        if (aBusCreatorResource != null) {
            httpServletRequest.setAttribute("aBusCreatorResource", aBusCreatorResource);
            // Start of user code getResourceAsHTML_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/buscreatorresource_html.jsp");
    ...
    public void busCreatorResourceSelector(@QueryParam("terms") final String terms,
        ...
        try {
            ...
            if (terms != null) {
                ...
                final List<BusCreatorResource> resources = SimulinkAdaptorManager.searchBusCreatorResources(
                        httpServletRequest, serviceProviderId, terms);
                if (resources != null) {
                    httpServletRequest.setAttribute("resources", resources);
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/buscreatorresourcefilteredcollection_json.jsp");
                ...
                try {
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/buscreatorresourceselector_html.jsp");
    ...
    public void busCreatorResourceCreatorAsHtml(@PathParam("serviceProviderId") final String serviceProviderId)
            throws IOException, ServletException {
        ...
        RequestDispatcher rd = httpServletRequest
                .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/buscreatorresourcecreator_html.jsp");
    ...
    public void createBusCreatorResourceFromHtml(@PathParam("serviceProviderId") final String serviceProviderId) {
        try {
            BusCreatorResource aBusCreatorResource = new BusCreatorResource();
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aBusCreatorResource.setSourceBlock(new Link(new URI(paramValues[0])));
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aBusCreatorResource.setTrigger(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aBusCreatorResource.addPorts(new Link(new URI(paramValues[i])));
                }
            }
            paramValues = httpServletRequest.getParameterValues("property");
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aBusCreatorResource.addProperty(paramValues[i]);
                }
            }
            paramValues = httpServletRequest.getParameterValues("inports");
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aBusCreatorResource.addInports(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aBusCreatorResource.setParent(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aBusCreatorResource.setName(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aBusCreatorResource.setEnabler(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aBusCreatorResource.addOutports(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aBusCreatorResource.setSimulinkRef(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            final BusCreatorResource newBusCreatorResource = SimulinkAdaptorManager.createBusCreatorResource(
                    httpServletRequest, aBusCreatorResource, serviceProviderId);

            httpServletRequest.setAttribute("newResource", newBusCreatorResource);
            httpServletRequest.setAttribute("newResourceUri", newBusCreatorResource.getAbout().toString());

            // Send back to the form a small JSON response
            httpServletResponse.setContentType("application/json");
            httpServletResponse.setStatus(Status.CREATED.getStatusCode());
            httpServletResponse.addHeader("Location", newBusCreatorResource.getAbout().toString());
            PrintWriter out = httpServletResponse.getWriter();
            out.print("{" + "\"resource\" : \"" + newBusCreatorResource.getAbout().toString() + "\"}");
            out.close();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
    ...
    @OslcCreationFactory(title = "DO_NOT_USE", label = "DO_NOT_USE", resourceShapes = { OslcConstants.PATH_RESOURCE_SHAPES
            + "/" + SimulinkAdaptorConstants.PATH_BUSCREATORRESOURCE }, resourceTypes = {
    ...
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public Response createBusCreatorResource(@PathParam("serviceProviderId") final String serviceProviderId,
            final BusCreatorResource aBusCreatorResource) throws IOException, ServletException {
        try {
            BusCreatorResource newBusCreatorResource = SimulinkAdaptorManager.createBusCreatorResource(
                    httpServletRequest, aBusCreatorResource, serviceProviderId);
            httpServletResponse.setHeader("ETag",
                    SimulinkAdaptorManager.getETagFromBusCreatorResource(newBusCreatorResource));
            return Response.created(newBusCreatorResource.getAbout()).entity(aBusCreatorResource).build();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
        }
