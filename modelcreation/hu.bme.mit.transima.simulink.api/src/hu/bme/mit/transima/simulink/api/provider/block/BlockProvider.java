package hu.bme.mit.transima.simulink.api.provider.block;

import hu.bme.mit.transima.simulink.api.adapter.block.BusCreatorAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.BusSelectorAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.DefaultAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.EnablePortAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.FromAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.GotoAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.GotoTagVisibilityAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.IBlockAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.InportAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.InportShadowAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.ModelReferenceAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.OutPortAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.ScopeAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.SubSystemAdapter;
import hu.bme.mit.transima.simulink.api.adapter.block.TriggerPortAdapter;
...
public class BlockProvider {
    ...
    public BlockProvider() {
        ...
        adapters.put(DEFAULT_BLOCK_ADAPTER, new DefaultAdapter());
    }
