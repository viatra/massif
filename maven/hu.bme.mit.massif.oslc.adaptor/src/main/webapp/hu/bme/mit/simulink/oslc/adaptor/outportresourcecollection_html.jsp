...
<%
    List<OutPortResource> resources = (List<OutPortResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>OutPortResource Query</title>
    <%--
...
End of user code 
        ...
        <% for (OutPortResource aOutPortResource : resources) { %>
