...
import hu.bme.mit.transima.models.simulink.derived.OutportsMatch;
...
/**
 * Generated pattern matcher API of the hu.bme.mit.transima.models.simulink.derived.outports pattern,
...
public class OutportsMatcher extends BaseMatcher<OutportsMatch> {
  ...
  public Set<Block> getAllValuesOfBlock(final OutPort pOutPort) {
    return rawAccumulateAllValuesOfBlock(new Object[]{null, pOutPort});
  }
