...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.viewer.gotoBlocks pattern,
...
public abstract class GotoBlocksMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("bl".equals(parameterName) ) {
    	this.fBl = (hu.bme.mit.massif.simulink.Goto) newValue;
    	return true;
    }
    return false;
  }
