...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.viewer.nonNullLineName pattern,
 * to be used in conjunction with {@link NonNullLineNameMatcher}.
 * 
...
public abstract class NonNullLineNameMatch extends BasePatternMatch {
  ...
  private NonNullLineNameMatch(final Connection pConn, final String pName) {
    this.fConn = pConn;
    this.fName = pName;
  }
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("conn".equals(parameterName) ) {
    	this.fConn = (hu.bme.mit.massif.simulink.Connection) newValue;
    	return true;
    }
  ...
  public List<String> parameterNames() {
    return NonNullLineNameMatch.parameterNames;
  }
  ...
  @Override
  public NonNullLineNameMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof NonNullLineNameMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    NonNullLineNameMatch other = (NonNullLineNameMatch) obj;
  ...
  @Override
  public NonNullLineNameQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static NonNullLineNameMatch newEmptyMatch() {
   ...
   * 
   */
  public static NonNullLineNameMatch newMutableMatch(final Connection pConn, final String pName) {
   ...
   * 
   */
  public static NonNullLineNameMatch newMatch(final Connection pConn, final String pName) {
    return new Immutable(pConn, pName);
  }
  
  private static final class Mutable extends NonNullLineNameMatch {
  ...
  private static final class Immutable extends NonNullLineNameMatch {
