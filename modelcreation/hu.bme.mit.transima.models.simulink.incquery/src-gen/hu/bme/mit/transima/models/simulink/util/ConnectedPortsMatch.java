...
/**
 * Pattern-specific match representation of the hu.bme.mit.transima.models.simulink.util.connectedPorts pattern,
...
public abstract class ConnectedPortsMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("firstPC".equals(parameterName) ) {
    	this.fFirstPC = (hu.bme.mit.transima.Simulink.SingleConnection) newValue;
    	return true;
    }
    return false;
