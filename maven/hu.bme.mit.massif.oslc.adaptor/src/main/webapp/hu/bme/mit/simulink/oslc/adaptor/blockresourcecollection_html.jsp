...
<%
    List<BlockResource> resources = (List<BlockResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>BlockResource Query</title>
    <%--
...
End of user code 
        ...
        <% for (BlockResource aBlockResource : resources) { %>
