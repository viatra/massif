...
<%
    List<EnableResource> resources = (List<EnableResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>EnableResource Query</title>
    <%--
...
End of user code 
        ...
        <% for (EnableResource aEnableResource : resources) { %>
