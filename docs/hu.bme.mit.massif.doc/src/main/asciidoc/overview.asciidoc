...
* Eclipse with Massif and prerequisites <<user/insatall_guide#, installed>>.
...
We welcome contributors, read the <<user/install_guide#, Developer Guide>> for setting up shop!