...
public final class EmptySubSystemQuerySpecification extends BaseGeneratedEMFQuerySpecification<EmptySubSystemMatcher> {
  private EmptySubSystemQuerySpecification() {
  ...
  public EmptySubSystemMatch newMatch(final Object... parameters) {
    return EmptySubSystemMatch.newMatch((hu.bme.mit.massif.simulink.SubSystem) parameters[0]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static EmptySubSystemQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "hu.bme.mit.massif.models.simulink.viewer.emptySubSystem";
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new NegativePatternCall(body, new FlatTuple(var_subS, var__bl), SubBlocksQuerySpecification.instance().getInternalQueryRepresentation());
      	bodies.add(body);
      }
      	{
