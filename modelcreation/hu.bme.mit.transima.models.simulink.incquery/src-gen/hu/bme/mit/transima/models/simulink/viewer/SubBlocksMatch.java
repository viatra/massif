...
/**
 * Pattern-specific match representation of the hu.bme.mit.transima.models.simulink.viewer.subBlocks pattern,
...
public abstract class SubBlocksMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("subSys".equals(parameterName) ) {
    	this.fSubSys = (hu.bme.mit.transima.Simulink.SubSystem) newValue;
    	return true;
    }
