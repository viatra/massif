...
/**
 * Pattern-specific match representation of the hu.bme.mit.transima.models.simulink.viewer.portBlock pattern,
...
public abstract class PortBlockMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("bl".equals(parameterName) ) {
    	this.fBl = (hu.bme.mit.transima.Simulink.PortBlock) newValue;
    	return true;
    }
    return false;
