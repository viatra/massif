...
public final class ReferencedModelQuerySpecification extends BaseGeneratedEMFQuerySpecification<ReferencedModelMatcher> {
  private ReferencedModelQuerySpecification() {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ReferencedModelQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new PositivePatternCall(body, new FlatTuple(var_ModelRef, var_SR), ReferenceEqualQuerySpecification.instance().getInternalQueryRepresentation());
      	bodies.add(body);
      }
      	{
