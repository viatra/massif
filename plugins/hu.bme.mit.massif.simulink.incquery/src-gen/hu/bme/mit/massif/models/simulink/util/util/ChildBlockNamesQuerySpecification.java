...
public final class ChildBlockNamesQuerySpecification extends BaseGeneratedQuerySpecification<ChildBlockNamesMatcher> {
  ...
  public Set<PBody> doGetContainedBodies() throws IncQueryException {
    Set<PBody> bodies = Sets.newLinkedHashSet();
    {
      ...
      new TypeBinary(body, CONTEXT, var_child, var_name, getFeatureLiteral("http://hu.bme.mit.massif/simulink/1.0", "SimulinkElement", "name"), "http://hu.bme.mit.massif/simulink/1.0/SimulinkElement.name");
      bodies.add(body);
    }
    {
      PBody body = new PBody(this);
