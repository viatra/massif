...
//    private ICommandEvaluator commandEvaluator;
    ...
    private void exportBlocks(EList<Block> sameLevelBlocks) throws SimulinkApiException {
        ...
        MatlabCommand findExistingBlocks = commandFactory.findSystem().addParam(containerFQN).addParam("IncludeCommented").addParam("on")
                .addParam("SearchDepth").addParam(1.0).addParam("type").addParam("block");
