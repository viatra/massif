...
public final class PortBlockInPortToOutPortQuerySpecification extends BaseGeneratedQuerySpecification<PortBlockInPortToOutPortMatcher> {
  ...
  public String getFullyQualifiedName() {
    return "hu.bme.mit.transima.models.simulink.util.portBlockInPortToOutPort";
  ...
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("inPortOfPBl", "hu.bme.mit.transima.Simulink.InPort"),new PParameter("outPort", "hu.bme.mit.transima.Simulink.OutPort"));
  }
  ...
  public PortBlockInPortToOutPortMatch newMatch(final Object... parameters) {
    return PortBlockInPortToOutPortMatch.newMatch((hu.bme.mit.transima.Simulink.InPort) parameters[0], (hu.bme.mit.transima.Simulink.OutPort) parameters[1]);
  }
  ...
  public Set<PBody> doGetContainedBodies() throws IncQueryException {
    Set<PBody> bodies = Sets.newLinkedHashSet();
    {
      ...
      new TypeUnary(body, var_inPortOfPBl, getClassifierLiteral("http://hu.bme.mit.transima/simulink/1.0", "InPort"), "http://hu.bme.mit.transima/simulink/1.0/InPort");
      ...
      new TypeBinary(body, CONTEXT, var_pBl, var_inPortOfPBl, getFeatureLiteral("http://hu.bme.mit.transima/simulink/1.0", "Block", "ports"), "http://hu.bme.mit.transima/simulink/1.0/Block.ports");
