...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.derived.enabler pattern,
...
public abstract class EnablerMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("Enabler".equals(parameterName) ) {
    	this.fEnabler = (hu.bme.mit.massif.simulink.Enable) newValue;
    	return true;
    }
    return false;
