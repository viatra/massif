...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.derived.referencedModel pattern,
...
public class ReferencedModelMatcher extends BaseMatcher<ReferencedModelMatch> {
  ...
  protected ReferencedModelMatch tupleToMatch(final Tuple t) {
    try {
      return ReferencedModelMatch.newMatch((hu.bme.mit.massif.simulink.ModelReference) t.get(POSITION_THIS), (hu.bme.mit.massif.simulink.SimulinkModel) t.get(POSITION_TARGET));
  ...
  protected ReferencedModelMatch arrayToMatch(final Object[] match) {
    try {
      return ReferencedModelMatch.newMatch((hu.bme.mit.massif.simulink.ModelReference) match[POSITION_THIS], (hu.bme.mit.massif.simulink.SimulinkModel) match[POSITION_TARGET]);
    } catch(ClassCastException e) {
  ...
  protected ReferencedModelMatch arrayToMatchMutable(final Object[] match) {
    try {
      return ReferencedModelMatch.newMutableMatch((hu.bme.mit.massif.simulink.ModelReference) match[POSITION_THIS], (hu.bme.mit.massif.simulink.SimulinkModel) match[POSITION_TARGET]);
    } catch(ClassCastException e) {
      LOGGER.error("Element(s) in array not properly typed!",e);
      return null;
    }
