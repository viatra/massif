...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.util.nextOutPortInPath pattern,
...
public abstract class NextOutPortInPathMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("nextOutPort".equals(parameterName) ) {
    	this.fNextOutPort = (hu.bme.mit.massif.simulink.OutPort) newValue;
    	return true;
    }
