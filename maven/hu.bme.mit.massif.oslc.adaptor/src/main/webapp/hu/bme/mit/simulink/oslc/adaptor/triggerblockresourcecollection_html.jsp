...
<%
    List<TriggerBlockResource> resources = (List<TriggerBlockResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>TriggerBlockResource Query</title>
    <%--
...
End of user code 
        ...
        <% for (TriggerBlockResource aTriggerBlockResource : resources) { %>
