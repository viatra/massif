...
import hu.bme.mit.transima.models.simulink.util.util.BusMappingInSelectorProcessor;
import hu.bme.mit.transima.models.simulink.util.util.BusSelectorProcessor;
...
import hu.bme.mit.transima.simulink.api.util.bus.BusSignalMappingPathFinder;
