...
public final class GotoConnectionQuerySpecification extends BaseGeneratedEMFQuerySpecification<GotoConnectionMatcher> {
  private GotoConnectionQuerySpecification() {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static GotoConnectionQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
