...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.derived.sourceBlock pattern,
...
public class SourceBlockMatcher extends BaseMatcher<SourceBlockMatch> {
  ...
  protected SourceBlockMatch tupleToMatch(final Tuple t) {
    try {
    	return SourceBlockMatch.newMatch((hu.bme.mit.massif.simulink.Block) t.get(POSITION_THIS), (hu.bme.mit.massif.simulink.Block) t.get(POSITION_SOURCE));
  ...
  protected SourceBlockMatch arrayToMatch(final Object[] match) {
    try {
    	return SourceBlockMatch.newMatch((hu.bme.mit.massif.simulink.Block) match[POSITION_THIS], (hu.bme.mit.massif.simulink.Block) match[POSITION_SOURCE]);
    } catch(ClassCastException e) {
  ...
  protected SourceBlockMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return SourceBlockMatch.newMutableMatch((hu.bme.mit.massif.simulink.Block) match[POSITION_THIS], (hu.bme.mit.massif.simulink.Block) match[POSITION_SOURCE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
