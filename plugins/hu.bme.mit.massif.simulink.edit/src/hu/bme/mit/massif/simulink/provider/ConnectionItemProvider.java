...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.massif.simulink.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionItemProvider extends SimulinkElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_lineName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_lineName_feature", "_UI_Connection_type"),
				 SimulinkPackage.Literals.CONNECTION__LINE_NAME,
				 true,
				 false,
				 false,
