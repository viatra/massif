...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.viewer.gotoConnection pattern,
...
public abstract class GotoConnectionMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("from".equals(parameterName) ) {
    	this.fFrom = (hu.bme.mit.massif.simulink.Goto) newValue;
    	return true;
    }
    if ("to".equals(parameterName) ) {
    	this.fTo = (hu.bme.mit.massif.simulink.From) newValue;
    	return true;
    }
    return false;
  }
