...
/**
 * A match processor tailored for the hu.bme.mit.transima.models.simulink.viewer.portOfSimpleBlock pattern.
 * 
...
public abstract class PortOfSimpleBlockProcessor implements IMatchProcessor<PortOfSimpleBlockMatch> {
  ...
  @Override
  public void process(final PortOfSimpleBlockMatch match) {
