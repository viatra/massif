...
@Path("/simu/{serviceProviderId}/portBlockResources")
public class PortBlockResourceService {
    @Context
    ...
    public PortBlockResourceService() {
        super();
    }
    ...
    public PortBlockResource[] getPortBlockResources(@PathParam("serviceProviderId") final String serviceProviderId,
        ...
        final List<PortBlockResource> resources = SimulinkAdaptorManager.getPortBlockResources(httpServletRequest,
                serviceProviderId, page, limit);
        return resources.toArray(new PortBlockResource[resources.size()]);
    ...
    public Response getPortBlockResourcesAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
        ...
        if (resources != null) {
            ...
            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/portblockresourcecollection_html.jsp");
    ...
    @Path("{portBlock}")
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public PortBlockResource getPortBlockResource(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("portBlock") final String portBlock) throws IOException, ServletException, URISyntaxException {
        // Start of user code (MUST_FILL_IN) getResource_init
        // End of user code

        final PortBlockResource aPortBlockResource = SimulinkAdaptorManager.getPortBlockResource(httpServletRequest,
                serviceProviderId, portBlock);

        if (aPortBlockResource != null) {
    ...
    @Path("{portBlock}")
    @Produces({ MediaType.TEXT_HTML })
    public Response getPortBlockResourceAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("portBlock") final String portBlock) throws ServletException, IOException, URISyntaxException {
        ...
        if (aPortBlockResource != null) {
            httpServletRequest.setAttribute("aPortBlockResource", aPortBlockResource);
            // Start of user code getResourceAsHTML_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/portblockresource_html.jsp");
    ...
    public void portBlockResourceSelector(@QueryParam("terms") final String terms,
        ...
        try {
            ...
            if (terms != null) {
                ...
                final List<PortBlockResource> resources = SimulinkAdaptorManager.searchPortBlockResources(
                        httpServletRequest, serviceProviderId, terms);
                if (resources != null) {
                    httpServletRequest.setAttribute("resources", resources);
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/portblockresourcefilteredcollection_json.jsp");
                ...
                try {
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/portblockresourceselector_html.jsp");
    ...
    public void portBlockResourceCreatorAsHtml(@PathParam("serviceProviderId") final String serviceProviderId)
            throws IOException, ServletException {
        ...
        RequestDispatcher rd = httpServletRequest
                .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/portblockresourcecreator_html.jsp");
    ...
    public void createPortBlockResourceFromHtml(@PathParam("serviceProviderId") final String serviceProviderId) {
        try {
            PortBlockResource aPortBlockResource = new PortBlockResource();
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aPortBlockResource.setSourceBlock(new Link(new URI(paramValues[0])));
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aPortBlockResource.setPort(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aPortBlockResource.setTrigger(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aPortBlockResource.addPorts(new Link(new URI(paramValues[i])));
                }
            }
            paramValues = httpServletRequest.getParameterValues("property");
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aPortBlockResource.addProperty(paramValues[i]);
                }
            }
            paramValues = httpServletRequest.getParameterValues("inports");
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aPortBlockResource.addInports(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aPortBlockResource.setParent(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aPortBlockResource.setName(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aPortBlockResource.setEnabler(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aPortBlockResource.addOutports(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aPortBlockResource.setSimulinkRef(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            final PortBlockResource newPortBlockResource = SimulinkAdaptorManager.createPortBlockResource(
                    httpServletRequest, aPortBlockResource, serviceProviderId);

            httpServletRequest.setAttribute("newResource", newPortBlockResource);
            httpServletRequest.setAttribute("newResourceUri", newPortBlockResource.getAbout().toString());

            // Send back to the form a small JSON response
            httpServletResponse.setContentType("application/json");
            httpServletResponse.setStatus(Status.CREATED.getStatusCode());
            httpServletResponse.addHeader("Location", newPortBlockResource.getAbout().toString());
            PrintWriter out = httpServletResponse.getWriter();
            out.print("{" + "\"resource\" : \"" + newPortBlockResource.getAbout().toString() + "\"}");
            out.close();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
    ...
    @OslcCreationFactory(title = "DO_NOT_USE", label = "DO_NOT_USE", resourceShapes = { OslcConstants.PATH_RESOURCE_SHAPES
            + "/" + SimulinkAdaptorConstants.PATH_PORTBLOCKRESOURCE }, resourceTypes = {
    ...
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public Response createPortBlockResource(@PathParam("serviceProviderId") final String serviceProviderId,
            final PortBlockResource aPortBlockResource) throws IOException, ServletException {
        try {
            PortBlockResource newPortBlockResource = SimulinkAdaptorManager.createPortBlockResource(httpServletRequest,
                    aPortBlockResource, serviceProviderId);
            httpServletResponse.setHeader("ETag",
                    SimulinkAdaptorManager.getETagFromPortBlockResource(newPortBlockResource));
            return Response.created(newPortBlockResource.getAbout()).entity(aPortBlockResource).build();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
        }
