...
import hu.bme.mit.transima.models.simulink.util.util.SimpleConnectedInPortQuerySpecification;
...
/**
 * Pattern-specific match representation of the hu.bme.mit.transima.models.simulink.util.simpleConnectedInPort pattern,
 * to be used in conjunction with {@link SimpleConnectedInPortMatcher}.
 * 
...
public abstract class SimpleConnectedInPortMatch extends BasePatternMatch {
  ...
  private SimpleConnectedInPortMatch(final InPort pSourceInPort, final InPort pTargetInPort) {
  ...
  public List<String> parameterNames() {
    return SimpleConnectedInPortMatch.parameterNames;
  ...
  public SimpleConnectedInPortMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SimpleConnectedInPortMatch)) { // this should be infrequent
    	if (obj == null)
    		return false;
    ...
    SimpleConnectedInPortMatch other = (SimpleConnectedInPortMatch) obj;
  ...
  public SimpleConnectedInPortQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SimpleConnectedInPortMatch newEmptyMatch() {
   ...
   * 
   */
  public static SimpleConnectedInPortMatch newMutableMatch(final InPort pSourceInPort, final InPort pTargetInPort) {
   ...
   * 
   */
  public static SimpleConnectedInPortMatch newMatch(final InPort pSourceInPort, final InPort pTargetInPort) {
    return new Immutable(pSourceInPort, pTargetInPort);
    
  }
  
  private static final class Mutable extends SimpleConnectedInPortMatch {
  ...
  private static final class Immutable extends SimpleConnectedInPortMatch {
