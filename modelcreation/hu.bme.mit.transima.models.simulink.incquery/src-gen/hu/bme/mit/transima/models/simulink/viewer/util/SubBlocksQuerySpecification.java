...
import hu.bme.mit.transima.models.simulink.viewer.SubBlocksMatcher;
...
public final class SubBlocksQuerySpecification extends BaseGeneratedQuerySpecification<SubBlocksMatcher> {
  ...
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("subSys", "hu.bme.mit.transima.Simulink.SubSystem"),new PParameter("bl", "hu.bme.mit.transima.Simulink.Block"));
  }
  ...
  public SubBlocksMatch newMatch(final Object... parameters) {
    return SubBlocksMatch.newMatch((hu.bme.mit.transima.Simulink.SubSystem) parameters[0], (hu.bme.mit.transima.Simulink.Block) parameters[1]);
  }
  ...
  public Set<PBody> doGetContainedBodies() throws IncQueryException {
    Set<PBody> bodies = Sets.newLinkedHashSet();
    {
      ...
      new TypeBinary(body, CONTEXT, var_subSys, var_bl, getFeatureLiteral("http://hu.bme.mit.transima/simulink/1.0", "SubSystem", "subBlocks"), "http://hu.bme.mit.transima/simulink/1.0/SubSystem.subBlocks");
      bodies.add(body);
    }
    {
