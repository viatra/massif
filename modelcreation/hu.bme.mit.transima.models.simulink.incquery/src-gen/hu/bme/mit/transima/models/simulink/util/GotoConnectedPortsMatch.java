...
/**
 * Pattern-specific match representation of the hu.bme.mit.transima.models.simulink.util.gotoConnectedPorts pattern,
...
public abstract class GotoConnectedPortsMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("gotoInPort".equals(parameterName) ) {
    	this.fGotoInPort = (hu.bme.mit.transima.Simulink.InPort) newValue;
    	return true;
    }
    if ("fromOutPort".equals(parameterName) ) {
    	this.fFromOutPort = (hu.bme.mit.transima.Simulink.OutPort) newValue;
    	return true;
    }
    return false;
