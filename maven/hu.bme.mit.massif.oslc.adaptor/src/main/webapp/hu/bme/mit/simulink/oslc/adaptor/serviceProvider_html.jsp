...
<%@ page import="org.eclipse.lyo.oslc4j.core.model.*" %>
...
End of user code 
        ...
        <p><%= serviceProvider.getDescription() %>
        </p>
...
End of user code 
        ...
        %>
        <p><a href="<%= selectionDialog %>"><%= selectionDialog %>
        </a></p>
        <%}%>
        ...
        %>
        <p><a href="<%= creationDialog %>"><%= creationDialog %>
        </a></p>
        <%}%>
        ...
        %>
        <p><a href="<%= creationFactory %>"><%= creationFactory %>
        </a></p>

        <p><a href="<%= creationShape %>"><%= creationShape %>
        </a></p>
        <%}%>
        ...
        <p><a href="<%= queryCapability %>"><%= queryCapability %>
        </a></p>

        <p><a href="<%= queryShape %>"><%= queryShape %>
        </a></p>
        <%}%>
        <%}%>
