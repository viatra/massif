...
public final class OutportsReachedFromBusSpecificationQuerySpecification extends BaseGeneratedQuerySpecification<OutportsReachedFromBusSpecificationMatcher> {
  ...
  public Set<PBody> doGetContainedBodies() throws IncQueryException {
    Set<PBody> bodies = Sets.newLinkedHashSet();
    {
      ...
      new TypeBinary(body, CONTEXT, var_nextSpec, var_inPort, getFeatureLiteral("http://hu.bme.mit.transima/simulink/1.0", "Block", "ports"), "http://hu.bme.mit.transima/simulink/1.0/Block.ports");
      bodies.add(body);
    }
    {
      PBody body = new PBody(this);
