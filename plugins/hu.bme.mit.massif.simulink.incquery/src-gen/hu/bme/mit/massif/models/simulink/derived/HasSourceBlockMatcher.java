...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.derived.hasSourceBlock pattern,
...
public class HasSourceBlockMatcher extends BaseMatcher<HasSourceBlockMatch> {
  ...
  protected HasSourceBlockMatch tupleToMatch(final Tuple t) {
    try {
      return HasSourceBlockMatch.newMatch((hu.bme.mit.massif.simulink.Block) t.get(POSITION_BL));
  ...
  protected HasSourceBlockMatch arrayToMatch(final Object[] match) {
    try {
      return HasSourceBlockMatch.newMatch((hu.bme.mit.massif.simulink.Block) match[POSITION_BL]);
    } catch(ClassCastException e) {
  ...
  protected HasSourceBlockMatch arrayToMatchMutable(final Object[] match) {
    try {
      return HasSourceBlockMatch.newMutableMatch((hu.bme.mit.massif.simulink.Block) match[POSITION_BL]);
    } catch(ClassCastException e) {
      LOGGER.error("Element(s) in array not properly typed!",e);
      return null;
    }
