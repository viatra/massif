...
/**
 * Generated pattern matcher API of the hu.bme.mit.transima.models.simulink.util.inPortToBlockPortOutPort pattern,
...
public class InPortToBlockPortOutPortMatcher extends BaseMatcher<InPortToBlockPortOutPortMatch> {
  ...
  public Set<InPort> getAllValuesOfinPort(final OutPort pOutPortOfPBl) {
    return rawAccumulateAllValuesOfinPort(new Object[]{null, pOutPortOfPBl});
  }
