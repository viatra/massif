...
public final class PortToPortConnectionQuerySpecification extends BaseGeneratedEMFQuerySpecification<PortToPortConnectionMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static PortToPortConnectionQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new PositivePatternCall(body, new FlatTuple(var_outP, var_from), PortOfSimpleBlockQuerySpecification.instance().getInternalQueryRepresentation());
      	...
      	new PositivePatternCall(body, new FlatTuple(var_inP, var_to), PortOfSimpleBlockQuerySpecification.instance().getInternalQueryRepresentation());
      	bodies.add(body);
      }
      	{
