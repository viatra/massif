...
/**
 * Pattern-specific match representation of the hu.bme.mit.transima.models.simulink.derived.referencedModel pattern,
...
public abstract class ReferencedModelMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("This".equals(parameterName) ) {
    	this.fThis = (hu.bme.mit.transima.Simulink.ModelReference) newValue;
    	return true;
    }
    if ("Target".equals(parameterName) ) {
    	this.fTarget = (hu.bme.mit.transima.Simulink.SimulinkModel) newValue;
    	return true;
    }
    return false;
