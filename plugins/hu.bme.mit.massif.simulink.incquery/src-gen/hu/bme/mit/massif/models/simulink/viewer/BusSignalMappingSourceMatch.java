...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.viewer.busSignalMappingSource pattern,
...
public abstract class BusSignalMappingSourceMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("busSelector".equals(parameterName) ) {
    	this.fBusSelector = (hu.bme.mit.massif.simulink.BusSelector) newValue;
    	return true;
    }
