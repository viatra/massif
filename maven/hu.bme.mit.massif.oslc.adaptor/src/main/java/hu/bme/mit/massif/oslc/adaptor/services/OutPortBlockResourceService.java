...
@Path("/simu/{serviceProviderId}/outPortBlockResources")
public class OutPortBlockResourceService {
    @Context
    ...
    public OutPortBlockResourceService() {
        super();
    }
    ...
    public OutPortBlockResource[] getOutPortBlockResources(
        ...
        final List<OutPortBlockResource> resources = SimulinkAdaptorManager.getOutPortBlockResources(
                httpServletRequest, serviceProviderId, page, limit);
        return resources.toArray(new OutPortBlockResource[resources.size()]);
    ...
    public Response getOutPortBlockResourcesAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
        ...
        if (resources != null) {
            ...
            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/outportblockresourcecollection_html.jsp");
    ...
    @Path("{outPort}")
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public OutPortBlockResource getOutPortBlockResource(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("outPort") final String outPort) throws IOException, ServletException, URISyntaxException {
        // Start of user code (MUST_FILL_IN) getResource_init
        // End of user code

        final OutPortBlockResource aOutPortBlockResource = SimulinkAdaptorManager.getOutPortBlockResource(
                httpServletRequest, serviceProviderId, outPort);

        if (aOutPortBlockResource != null) {
    ...
    @Path("{outPort}")
    @Produces({ MediaType.TEXT_HTML })
    public Response getOutPortBlockResourceAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("outPort") final String outPort) throws ServletException, IOException, URISyntaxException {
        ...
        if (aOutPortBlockResource != null) {
            httpServletRequest.setAttribute("aOutPortBlockResource", aOutPortBlockResource);
            // Start of user code getResourceAsHTML_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/outportblockresource_html.jsp");
    ...
    public void outPortBlockResourceSelector(@QueryParam("terms") final String terms,
        ...
        try {
            ...
            if (terms != null) {
                ...
                final List<OutPortBlockResource> resources = SimulinkAdaptorManager.searchOutPortBlockResources(
                        httpServletRequest, serviceProviderId, terms);
                if (resources != null) {
                    httpServletRequest.setAttribute("resources", resources);
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/outportblockresourcefilteredcollection_json.jsp");
                ...
                try {
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/outportblockresourceselector_html.jsp");
    ...
    public void outPortBlockResourceCreatorAsHtml(@PathParam("serviceProviderId") final String serviceProviderId)
            throws IOException, ServletException {
        ...
        RequestDispatcher rd = httpServletRequest
                .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/outportblockresourcecreator_html.jsp");
    ...
    public void createOutPortBlockResourceFromHtml(@PathParam("serviceProviderId") final String serviceProviderId) {
        try {
            OutPortBlockResource aOutPortBlockResource = new OutPortBlockResource();
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aOutPortBlockResource.setSourceBlock(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }

            }
            paramValues = httpServletRequest.getParameterValues("port");
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aOutPortBlockResource.setPort(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aOutPortBlockResource.setTrigger(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aOutPortBlockResource.addPorts(new Link(new URI(paramValues[i])));
                }
            }
            paramValues = httpServletRequest.getParameterValues("property");
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aOutPortBlockResource.addProperty(paramValues[i]);
                }
            }
            paramValues = httpServletRequest.getParameterValues("inports");
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aOutPortBlockResource.addInports(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aOutPortBlockResource.setParent(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aOutPortBlockResource.setName(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aOutPortBlockResource.setEnabler(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aOutPortBlockResource.addOutports(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aOutPortBlockResource.setSimulinkRef(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            final OutPortBlockResource newOutPortBlockResource = SimulinkAdaptorManager.createOutPortBlockResource(
                    httpServletRequest, aOutPortBlockResource, serviceProviderId);

            httpServletRequest.setAttribute("newResource", newOutPortBlockResource);
            httpServletRequest.setAttribute("newResourceUri", newOutPortBlockResource.getAbout().toString());

            // Send back to the form a small JSON response
            httpServletResponse.setContentType("application/json");
            httpServletResponse.setStatus(Status.CREATED.getStatusCode());
            httpServletResponse.addHeader("Location", newOutPortBlockResource.getAbout().toString());
            PrintWriter out = httpServletResponse.getWriter();
            out.print("{" + "\"resource\" : \"" + newOutPortBlockResource.getAbout().toString() + "\"}");
            out.close();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
    ...
    @OslcCreationFactory(title = "DO_NOT_USE", label = "DO_NOT_USE", resourceShapes = { OslcConstants.PATH_RESOURCE_SHAPES
            + "/" + SimulinkAdaptorConstants.PATH_OUTPORTBLOCKRESOURCE }, resourceTypes = {
    ...
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public Response createOutPortBlockResource(@PathParam("serviceProviderId") final String serviceProviderId,
            final OutPortBlockResource aOutPortBlockResource) throws IOException, ServletException {
        try {
            OutPortBlockResource newOutPortBlockResource = SimulinkAdaptorManager.createOutPortBlockResource(
                    httpServletRequest, aOutPortBlockResource, serviceProviderId);
            httpServletResponse.setHeader("ETag",
                    SimulinkAdaptorManager.getETagFromOutPortBlockResource(newOutPortBlockResource));
            return Response.created(newOutPortBlockResource.getAbout()).entity(aOutPortBlockResource).build();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
        }
