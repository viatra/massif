...
<%
    List<SubSystemResource> resources = (List<SubSystemResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>SubSystemResource Query</title>
    <%--
...
End of user code 
        ...
        <% for (SubSystemResource aSubSystemResource : resources) { %>
