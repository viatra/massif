...
<%
    List<InPortBlockResource> resources = (List<InPortBlockResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>InPortBlockResource Query</title>
    <%--
...
End of user code 
        ...
        <% for (InPortBlockResource aInPortBlockResource : resources) { %>
