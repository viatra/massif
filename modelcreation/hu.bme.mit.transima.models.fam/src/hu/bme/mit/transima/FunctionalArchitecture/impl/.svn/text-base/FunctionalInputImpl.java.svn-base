 ...
 * <ul>
 *   <li>{@link hu.bme.mit.transima.FunctionalArchitecture.impl.FunctionalInputImpl#getIncomingLinks <em>Incoming Links</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionalInputImpl extends FunctionalDataImpl implements FunctionalInput {
    ...
    protected EClass eStaticClass() {
        return FunctionalArchitectureModelPackage.Literals.FUNCTIONAL_INPUT;
    }
    ...
    public EList<InformationLink> getIncomingLinks() {
        if (incomingLinks == null) {
            incomingLinks = new EObjectWithInverseResolvingEList<InformationLink>(InformationLink.class, this, FunctionalArchitectureModelPackage.FUNCTIONAL_INPUT__INCOMING_LINKS, FunctionalArchitectureModelPackage.INFORMATION_LINK__TO);
        }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case FunctionalArchitectureModelPackage.FUNCTIONAL_INPUT__INCOMING_LINKS:
