...
@Path("/simu/{serviceProviderId}/inPortBlockResources")
public class InPortBlockResourceService {
    @Context
    ...
    public InPortBlockResourceService() {
        super();
    }
    ...
    public InPortBlockResource[] getInPortBlockResources(
        ...
        final List<InPortBlockResource> resources = SimulinkAdaptorManager.getInPortBlockResources(httpServletRequest,
                serviceProviderId, page, limit);
        return resources.toArray(new InPortBlockResource[resources.size()]);
    ...
    public Response getInPortBlockResourcesAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
        ...
        if (resources != null) {
            ...
            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/inportblockresourcecollection_html.jsp");
    ...
    @Path("{outPortBlock}")
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public InPortBlockResource getInPortBlockResource(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("outPortBlock") final String outPortBlock) throws IOException, ServletException,
            URISyntaxException {
        // Start of user code (MUST_FILL_IN) getResource_init
        // End of user code

        final InPortBlockResource aInPortBlockResource = SimulinkAdaptorManager.getInPortBlockResource(
                httpServletRequest, serviceProviderId, outPortBlock);

        if (aInPortBlockResource != null) {
    ...
    @Path("{outPortBlock}")
    @Produces({ MediaType.TEXT_HTML })
    public Response getInPortBlockResourceAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("outPortBlock") final String outPortBlock) throws ServletException, IOException,
            URISyntaxException {
        ...
        if (aInPortBlockResource != null) {
            httpServletRequest.setAttribute("aInPortBlockResource", aInPortBlockResource);
            // Start of user code getResourceAsHTML_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/inportblockresource_html.jsp");
    ...
    public void inPortBlockResourceSelector(@QueryParam("terms") final String terms,
        ...
        try {
            ...
            if (terms != null) {
                ...
                final List<InPortBlockResource> resources = SimulinkAdaptorManager.searchInPortBlockResources(
                        httpServletRequest, serviceProviderId, terms);
                if (resources != null) {
                    httpServletRequest.setAttribute("resources", resources);
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/inportblockresourcefilteredcollection_json.jsp");
                ...
                try {
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/inportblockresourceselector_html.jsp");
    ...
    public void inPortBlockResourceCreatorAsHtml(@PathParam("serviceProviderId") final String serviceProviderId)
            throws IOException, ServletException {
        ...
        RequestDispatcher rd = httpServletRequest
                .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/inportblockresourcecreator_html.jsp");
    ...
    public void createInPortBlockResourceFromHtml(@PathParam("serviceProviderId") final String serviceProviderId) {
        try {
            InPortBlockResource aInPortBlockResource = new InPortBlockResource();
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aInPortBlockResource.setSourceBlock(new Link(new URI(paramValues[0])));
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aInPortBlockResource.setPort(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aInPortBlockResource.setTrigger(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aInPortBlockResource.addPorts(new Link(new URI(paramValues[i])));
                }
            }
            paramValues = httpServletRequest.getParameterValues("property");
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aInPortBlockResource.addProperty(paramValues[i]);
                }
            }
            paramValues = httpServletRequest.getParameterValues("inports");
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aInPortBlockResource.addInports(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aInPortBlockResource.setParent(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aInPortBlockResource.setName(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aInPortBlockResource.setEnabler(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aInPortBlockResource.addOutports(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aInPortBlockResource.setSimulinkRef(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            final InPortBlockResource newInPortBlockResource = SimulinkAdaptorManager.createInPortBlockResource(
                    httpServletRequest, aInPortBlockResource, serviceProviderId);

            httpServletRequest.setAttribute("newResource", newInPortBlockResource);
            httpServletRequest.setAttribute("newResourceUri", newInPortBlockResource.getAbout().toString());

            // Send back to the form a small JSON response
            httpServletResponse.setContentType("application/json");
            httpServletResponse.setStatus(Status.CREATED.getStatusCode());
            httpServletResponse.addHeader("Location", newInPortBlockResource.getAbout().toString());
            PrintWriter out = httpServletResponse.getWriter();
            out.print("{" + "\"resource\" : \"" + newInPortBlockResource.getAbout().toString() + "\"}");
            out.close();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
    ...
    @OslcCreationFactory(title = "DO_NOT_USE", label = "DO_NOT_USE", resourceShapes = { OslcConstants.PATH_RESOURCE_SHAPES
            + "/" + SimulinkAdaptorConstants.PATH_INPORTBLOCKRESOURCE }, resourceTypes = {
    ...
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public Response createInPortBlockResource(@PathParam("serviceProviderId") final String serviceProviderId,
            final InPortBlockResource aInPortBlockResource) throws IOException, ServletException {
        try {
            InPortBlockResource newInPortBlockResource = SimulinkAdaptorManager.createInPortBlockResource(
                    httpServletRequest, aInPortBlockResource, serviceProviderId);
            httpServletResponse.setHeader("ETag",
                    SimulinkAdaptorManager.getETagFromInPortBlockResource(newInPortBlockResource));
            return Response.created(newInPortBlockResource.getAbout()).entity(aInPortBlockResource).build();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
        }
