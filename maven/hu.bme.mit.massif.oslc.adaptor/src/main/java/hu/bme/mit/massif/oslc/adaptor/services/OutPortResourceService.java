...
@Path("/simu/{serviceProviderId}/outPortResources")
public class OutPortResourceService {
    @Context
    ...
    public OutPortResource[] getOutPortResources(@PathParam("serviceProviderId") final String serviceProviderId,
        ...
        final List<OutPortResource> resources = SimulinkAdaptorManager.getOutPortResources(httpServletRequest,
                serviceProviderId, page, limit);
        return resources.toArray(new OutPortResource[resources.size()]);
    ...
    public Response getOutPortResourcesAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
        ...
        if (resources != null) {
            ...
            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/outportresourcecollection_html.jsp");
    ...
    @Path("{outPRes}")
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public OutPortResource getOutPortResource(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("outPRes") final String outPRes) throws IOException, ServletException, URISyntaxException {
        // Start of user code (MUST_FILL_IN) getResource_init
        // End of user code

        final OutPortResource aOutPortResource = SimulinkAdaptorManager.getOutPortResource(httpServletRequest,
                serviceProviderId, outPRes);

        if (aOutPortResource != null) {
    ...
    @Path("{outPRes}")
    @Produces({ MediaType.TEXT_HTML })
    public Response getOutPortResourceAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("outPRes") final String outPRes) throws ServletException, IOException, URISyntaxException {
        ...
        if (aOutPortResource != null) {
            httpServletRequest.setAttribute("aOutPortResource", aOutPortResource);
            // Start of user code getResourceAsHTML_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/outportresource_html.jsp");
    ...
    public void outPortResourceSelector(@QueryParam("terms") final String terms,
        ...
        try {
            ...
            if (terms != null) {
                ...
                final List<OutPortResource> resources = SimulinkAdaptorManager.searchOutPortResources(
                        httpServletRequest, serviceProviderId, terms);
                if (resources != null) {
                    httpServletRequest.setAttribute("resources", resources);
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/outportresourcefilteredcollection_json.jsp");
                ...
                try {
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/outportresourceselector_html.jsp");
    ...
    public void outPortResourceCreatorAsHtml(@PathParam("serviceProviderId") final String serviceProviderId)
            throws IOException, ServletException {
        ...
        RequestDispatcher rd = httpServletRequest
                .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/outportresourcecreator_html.jsp");
    ...
    public void createOutPortResourceFromHtml(@PathParam("serviceProviderId") final String serviceProviderId) {
        try {
            OutPortResource aOutPortResource = new OutPortResource();
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aOutPortResource.addConnections(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aOutPortResource.setContainer(new Link(new URI(paramValues[0])));
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aOutPortResource.setPortBlock(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aOutPortResource.setName(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aOutPortResource.setSimulinkRef(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            final OutPortResource newOutPortResource = SimulinkAdaptorManager.createOutPortResource(httpServletRequest,
                    aOutPortResource, serviceProviderId);

            httpServletRequest.setAttribute("newResource", newOutPortResource);
            httpServletRequest.setAttribute("newResourceUri", newOutPortResource.getAbout().toString());

            // Send back to the form a small JSON response
            httpServletResponse.setContentType("application/json");
            httpServletResponse.setStatus(Status.CREATED.getStatusCode());
            httpServletResponse.addHeader("Location", newOutPortResource.getAbout().toString());
            PrintWriter out = httpServletResponse.getWriter();
            out.print("{" + "\"resource\" : \"" + newOutPortResource.getAbout().toString() + "\"}");
            out.close();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
    ...
    @OslcCreationFactory(title = "DO_NOT_USE", label = "DO_NOT_USE", resourceShapes = { OslcConstants.PATH_RESOURCE_SHAPES
            + "/" + SimulinkAdaptorConstants.PATH_OUTPORTRESOURCE }, resourceTypes = {
    ...
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public Response createOutPortResource(@PathParam("serviceProviderId") final String serviceProviderId,
            final OutPortResource aOutPortResource) throws IOException, ServletException {
        try {
            OutPortResource newOutPortResource = SimulinkAdaptorManager.createOutPortResource(httpServletRequest,
                    aOutPortResource, serviceProviderId);
            httpServletResponse
                    .setHeader("ETag", SimulinkAdaptorManager.getETagFromOutPortResource(newOutPortResource));
            return Response.created(newOutPortResource.getAbout()).entity(aOutPortResource).build();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
        }
