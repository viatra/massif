...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.util.portConnection pattern,
...
public class PortConnectionMatcher extends BaseMatcher<PortConnectionMatch> {
  ...
  protected PortConnectionMatch tupleToMatch(final Tuple t) {
    try {
      return PortConnectionMatch.newMatch((hu.bme.mit.massif.simulink.OutPort) t.get(POSITION_OUTP), (hu.bme.mit.massif.simulink.InPort) t.get(POSITION_INP), (hu.bme.mit.massif.simulink.SingleConnection) t.get(POSITION_PC));
  ...
  protected PortConnectionMatch arrayToMatch(final Object[] match) {
    try {
      return PortConnectionMatch.newMatch((hu.bme.mit.massif.simulink.OutPort) match[POSITION_OUTP], (hu.bme.mit.massif.simulink.InPort) match[POSITION_INP], (hu.bme.mit.massif.simulink.SingleConnection) match[POSITION_PC]);
    } catch(ClassCastException e) {
  ...
  protected PortConnectionMatch arrayToMatchMutable(final Object[] match) {
    try {
      return PortConnectionMatch.newMutableMatch((hu.bme.mit.massif.simulink.OutPort) match[POSITION_OUTP], (hu.bme.mit.massif.simulink.InPort) match[POSITION_INP], (hu.bme.mit.massif.simulink.SingleConnection) match[POSITION_PC]);
    } catch(ClassCastException e) {
      LOGGER.error("Element(s) in array not properly typed!",e);
      return null;
    }
