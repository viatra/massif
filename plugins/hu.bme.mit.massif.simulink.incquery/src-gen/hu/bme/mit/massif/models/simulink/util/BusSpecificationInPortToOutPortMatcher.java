...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.util.busSpecificationInPortToOutPort pattern,
...
public class BusSpecificationInPortToOutPortMatcher extends BaseMatcher<BusSpecificationInPortToOutPortMatch> {
  ...
  public Set<InPort> getAllValuesOfinportOfBS(final OutPort pOutPortOfBS) {
    return rawAccumulateAllValuesOfinportOfBS(new Object[]{
    null, 
    pOutPortOfBS
    });
  }
  ...
  public Set<OutPort> getAllValuesOfoutPortOfBS(final InPort pInportOfBS) {
    return rawAccumulateAllValuesOfoutPortOfBS(new Object[]{
    pInportOfBS, 
    null
    });
  }
  ...
  protected BusSpecificationInPortToOutPortMatch tupleToMatch(final Tuple t) {
    try {
    	return BusSpecificationInPortToOutPortMatch.newMatch((hu.bme.mit.massif.simulink.InPort) t.get(POSITION_INPORTOFBS), (hu.bme.mit.massif.simulink.OutPort) t.get(POSITION_OUTPORTOFBS));
  ...
  protected BusSpecificationInPortToOutPortMatch arrayToMatch(final Object[] match) {
    try {
    	return BusSpecificationInPortToOutPortMatch.newMatch((hu.bme.mit.massif.simulink.InPort) match[POSITION_INPORTOFBS], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_OUTPORTOFBS]);
    } catch(ClassCastException e) {
  ...
  protected BusSpecificationInPortToOutPortMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return BusSpecificationInPortToOutPortMatch.newMutableMatch((hu.bme.mit.massif.simulink.InPort) match[POSITION_INPORTOFBS], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_OUTPORTOFBS]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
