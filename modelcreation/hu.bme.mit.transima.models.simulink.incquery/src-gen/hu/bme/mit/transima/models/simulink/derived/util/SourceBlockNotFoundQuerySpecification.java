...
public final class SourceBlockNotFoundQuerySpecification extends BaseGeneratedQuerySpecification<SourceBlockNotFoundMatcher> {
  ...
  public Set<PBody> doGetContainedBodies() throws IncQueryException {
    Set<PBody> bodies = Sets.newLinkedHashSet();
    {
      ...
      new TypeBinary(body, CONTEXT, var_Block, var_BlRef, getFeatureLiteral("http://hu.bme.mit.transima/simulink/1.0", "Block", "sourceBlockRef"), "http://hu.bme.mit.transima/simulink/1.0/Block.sourceBlockRef");
