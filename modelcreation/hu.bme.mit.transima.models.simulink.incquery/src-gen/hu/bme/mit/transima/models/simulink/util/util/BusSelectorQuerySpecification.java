...
public final class BusSelectorQuerySpecification extends BaseGeneratedQuerySpecification<BusSelectorMatcher> {
  ...
  public Set<PBody> doGetContainedBodies() throws IncQueryException {
    Set<PBody> bodies = Sets.newLinkedHashSet();
    {
      ...
      new TypeUnary(body, var_selector, getClassifierLiteral("http://hu.bme.mit.transima/simulink/1.0", "BusSelector"), "http://hu.bme.mit.transima/simulink/1.0/BusSelector");
      bodies.add(body);
    }
    return bodies;
  }
