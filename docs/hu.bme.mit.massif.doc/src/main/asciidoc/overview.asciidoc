...
* Release 0.7.0: VIATRA Query runtime 2.0 http://download.eclipse.org/viatra/updates/release/latest
* Upcoming release 0.8.0: VIATRA Query runtime 2.0 http://download.eclipse.org/viatra/updates/release/latest
