...
import hu.bme.mit.massif.simulink.cli.base.AbstractCLIMatlabCreator;

/**
 * @author Barnabás Reischl
 *
 */
public class CLIMatlabCreator extends AbstractCLIMatlabCreator {
    ...
    public AbstractCommandEvaluator<? extends ICommandAccess> getEvaluator() {
        ...
        return new AbstractCommandEvaluator<ICommandAccess>(new LocalScriptAccess(controller));
    }
}
