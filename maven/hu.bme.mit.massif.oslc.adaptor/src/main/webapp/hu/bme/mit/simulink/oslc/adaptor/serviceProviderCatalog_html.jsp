...
<head>
    ...
    <title>SimulinkAdaptor OSLC Adapter: Service Provider Catalog</title>
    <%--
...
<div id="header">
    ...
    <table border="0" cellspacing="0" cellpadding="0" id="titles">
        <tr>
            <td id="title">
                <p>
                    Simulink-OSLC-Provider: Service Provider Catalog
                </p>
            </td>
            <td id="information">
...
End of user code 
        ...
        <p>Provides services to enable browsing a simulink model.</p>
...
End of user code 
        ...
        <h3>Service Provider: <%= s.getTitle() %>
        </h3>
