...
@Path("/simu/{serviceProviderId}/busSelectorResources")
public class BusSelectorResourceService {
    @Context
    ...
    public BusSelectorResourceService() {
        super();
    }
    ...
    public BusSelectorResource[] getBusSelectorResources(
        ...
        final List<BusSelectorResource> resources = SimulinkAdaptorManager.getBusSelectorResources(httpServletRequest,
                serviceProviderId, page, limit);
        return resources.toArray(new BusSelectorResource[resources.size()]);
    ...
    public Response getBusSelectorResourcesAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
        ...
        if (resources != null) {
            ...
            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/busselectorresourcecollection_html.jsp");
    ...
    @Path("{busSelectorId}")
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public BusSelectorResource getBusSelectorResource(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("busSelectorId") final String busSelectorId) throws IOException, ServletException,
            URISyntaxException {
        // Start of user code (MUST_FILL_IN) getResource_init
        // End of user code

        final BusSelectorResource aBusSelectorResource = SimulinkAdaptorManager.getBusSelectorResource(
                httpServletRequest, serviceProviderId, busSelectorId);

        if (aBusSelectorResource != null) {
    ...
    @Path("{busSelectorId}")
    @Produces({ MediaType.TEXT_HTML })
    public Response getBusSelectorResourceAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("busSelectorId") final String busSelectorId) throws ServletException, IOException,
            URISyntaxException {
        ...
        if (aBusSelectorResource != null) {
            httpServletRequest.setAttribute("aBusSelectorResource", aBusSelectorResource);
            // Start of user code getResourceAsHTML_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/busselectorresource_html.jsp");
    ...
    public void busSelectorResourceSelector(@QueryParam("terms") final String terms,
        ...
        try {
            ...
            if (terms != null) {
                ...
                final List<BusSelectorResource> resources = SimulinkAdaptorManager.searchBusSelectorResources(
                        httpServletRequest, serviceProviderId, terms);
                if (resources != null) {
                    httpServletRequest.setAttribute("resources", resources);
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/busselectorresourcefilteredcollection_json.jsp");
                ...
                try {
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/busselectorresourceselector_html.jsp");
    ...
    public void busSelectorResourceCreatorAsHtml(@PathParam("serviceProviderId") final String serviceProviderId)
            throws IOException, ServletException {
        ...
        RequestDispatcher rd = httpServletRequest
                .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/busselectorresourcecreator_html.jsp");
    ...
    public void createBusSelectorResourceFromHtml(@PathParam("serviceProviderId") final String serviceProviderId) {
        try {
            BusSelectorResource aBusSelectorResource = new BusSelectorResource();
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aBusSelectorResource.setSourceBlock(new Link(new URI(paramValues[0])));
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aBusSelectorResource.setTrigger(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aBusSelectorResource.addPorts(new Link(new URI(paramValues[i])));
                }
            }
            paramValues = httpServletRequest.getParameterValues("property");
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aBusSelectorResource.addProperty(paramValues[i]);
                }
            }
            paramValues = httpServletRequest.getParameterValues("inports");
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aBusSelectorResource.addInports(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aBusSelectorResource.setParent(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aBusSelectorResource.setName(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aBusSelectorResource.setEnabler(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aBusSelectorResource.addOutports(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aBusSelectorResource.setSimulinkRef(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            final BusSelectorResource newBusSelectorResource = SimulinkAdaptorManager.createBusSelectorResource(
                    httpServletRequest, aBusSelectorResource, serviceProviderId);

            httpServletRequest.setAttribute("newResource", newBusSelectorResource);
            httpServletRequest.setAttribute("newResourceUri", newBusSelectorResource.getAbout().toString());

            // Send back to the form a small JSON response
            httpServletResponse.setContentType("application/json");
            httpServletResponse.setStatus(Status.CREATED.getStatusCode());
            httpServletResponse.addHeader("Location", newBusSelectorResource.getAbout().toString());
            PrintWriter out = httpServletResponse.getWriter();
            out.print("{" + "\"resource\" : \"" + newBusSelectorResource.getAbout().toString() + "\"}");
            out.close();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
    ...
    @OslcCreationFactory(title = "DO_NOT_USE", label = "DO_NOT_USE", resourceShapes = { OslcConstants.PATH_RESOURCE_SHAPES
            + "/" + SimulinkAdaptorConstants.PATH_BUSSELECTORRESOURCE }, resourceTypes = {
    ...
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public Response createBusSelectorResource(@PathParam("serviceProviderId") final String serviceProviderId,
            final BusSelectorResource aBusSelectorResource) throws IOException, ServletException {
        try {
            BusSelectorResource newBusSelectorResource = SimulinkAdaptorManager.createBusSelectorResource(
                    httpServletRequest, aBusSelectorResource, serviceProviderId);
            httpServletResponse.setHeader("ETag",
                    SimulinkAdaptorManager.getETagFromBusSelectorResource(newBusSelectorResource));
            return Response.created(newBusSelectorResource.getAbout()).entity(aBusSelectorResource).build();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
        }
