 ...
 * @generated
 */
public class SimulinkModelTest extends SimulinkElementTest {
	...
	public static void main(String[] args) {
		TestRunner.run(SimulinkModelTest.class);
	}
	 ...
	 * @generated
	 */
	public SimulinkModelTest(String name) {
		super(name);
	}
	 ...
	 */
	@Override
	protected SimulinkModel getFixture() {
		return (SimulinkModel)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(SimulinkFactory.eINSTANCE.createSimulinkModel());
	}
