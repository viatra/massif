...
<%
    List<OutPortBlockResource> resources = (List<OutPortBlockResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>OutPortBlockResource Query</title>
    <%--
...
End of user code 
        ...
        <% for (OutPortBlockResource aOutPortBlockResource : resources) { %>
