...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.util.simpleInPortToInPortConnection pattern,
...
public class SimpleInPortToInPortConnectionMatcher extends BaseMatcher<SimpleInPortToInPortConnectionMatch> {
  ...
  protected SimpleInPortToInPortConnectionMatch tupleToMatch(final Tuple t) {
    try {
    	return SimpleInPortToInPortConnectionMatch.newMatch((hu.bme.mit.massif.simulink.InPort) t.get(POSITION_SOURCEINPORT), (hu.bme.mit.massif.simulink.InPort) t.get(POSITION_TARGETINPORT), (hu.bme.mit.massif.simulink.SingleConnection) t.get(POSITION_CONNECTION));
  ...
  protected SimpleInPortToInPortConnectionMatch arrayToMatch(final Object[] match) {
    try {
    	return SimpleInPortToInPortConnectionMatch.newMatch((hu.bme.mit.massif.simulink.InPort) match[POSITION_SOURCEINPORT], (hu.bme.mit.massif.simulink.InPort) match[POSITION_TARGETINPORT], (hu.bme.mit.massif.simulink.SingleConnection) match[POSITION_CONNECTION]);
    } catch(ClassCastException e) {
  ...
  protected SimpleInPortToInPortConnectionMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return SimpleInPortToInPortConnectionMatch.newMutableMatch((hu.bme.mit.massif.simulink.InPort) match[POSITION_SOURCEINPORT], (hu.bme.mit.massif.simulink.InPort) match[POSITION_TARGETINPORT], (hu.bme.mit.massif.simulink.SingleConnection) match[POSITION_CONNECTION]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
