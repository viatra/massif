 ...
 * <ul>
 *   <li>{@link hu.bme.mit.transima.Simulink.BusSelector#getMappings <em>Mappings</em>}</li>
 *   <li>{@link hu.bme.mit.transima.Simulink.BusSelector#isOutputAsBus <em>Output As Bus</em>}</li>
 *   <li>{@link hu.bme.mit.transima.Simulink.BusSelector#getBusCreator <em>Bus Creator</em>}</li>
 * </ul>
 * </p>
 *
 * @see hu.bme.mit.transima.Simulink.SimulinkPackage#getBusSelector()
 * @model
 * @generated
 */
public interface BusSelector extends BusSpecification {
	 ...
	 * The list contents are of type {@link hu.bme.mit.transima.Simulink.BusSignalMapping}.
	 * It is bidirectional and its opposite is '{@link hu.bme.mit.transima.Simulink.BusSignalMapping#getSelector <em>Selector</em>}'.
	 * <!-- begin-user-doc -->
     * <p>
	 ...
	 * @see hu.bme.mit.transima.Simulink.SimulinkPackage#getBusSelector_Mappings()
	 ...
	 * @see hu.bme.mit.transima.Simulink.SimulinkPackage#getBusSelector_OutputAsBus()
	 * @model
	 * @generated
	 */
	boolean isOutputAsBus();
				...
				/**
	 * Sets the value of the '{@link hu.bme.mit.transima.Simulink.BusSelector#isOutputAsBus <em>Output As Bus</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see hu.bme.mit.transima.Simulink.SimulinkPackage#getBusSelector_BusCreator()
	 * @model
	 * @generated
	 */
	BusSpecification getBusCreator();
				...
				/**
	 * Sets the value of the '{@link hu.bme.mit.transima.Simulink.BusSelector#getBusCreator <em>Bus Creator</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
