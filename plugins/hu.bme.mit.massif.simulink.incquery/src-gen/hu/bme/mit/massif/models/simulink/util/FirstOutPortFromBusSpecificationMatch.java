...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.util.firstOutPortFromBusSpecification pattern,
 * to be used in conjunction with {@link FirstOutPortFromBusSpecificationMatcher}.
 * 
...
public abstract class FirstOutPortFromBusSpecificationMatch extends BasePatternMatch {
  ...
  private FirstOutPortFromBusSpecificationMatch(final OutPort pOutPort, final BusSpecification pNextSpec, final OutPort pEndPortBeforeNextSpec) {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("nextSpec".equals(parameterName) ) {
    	this.fNextSpec = (hu.bme.mit.massif.simulink.BusSpecification) newValue;
    	return true;
    }
    if ("endPortBeforeNextSpec".equals(parameterName) ) {
    	this.fEndPortBeforeNextSpec = (hu.bme.mit.massif.simulink.OutPort) newValue;
    	return true;
    }
    return false;
  }
  ...
  public List<String> parameterNames() {
    return FirstOutPortFromBusSpecificationMatch.parameterNames;
  }
  ...
  @Override
  public FirstOutPortFromBusSpecificationMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof FirstOutPortFromBusSpecificationMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    FirstOutPortFromBusSpecificationMatch other = (FirstOutPortFromBusSpecificationMatch) obj;
  ...
  @Override
  public FirstOutPortFromBusSpecificationQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static FirstOutPortFromBusSpecificationMatch newMutableMatch(final OutPort pOutPort, final BusSpecification pNextSpec, final OutPort pEndPortBeforeNextSpec) {
   ...
   * 
   */
  public static FirstOutPortFromBusSpecificationMatch newMatch(final OutPort pOutPort, final BusSpecification pNextSpec, final OutPort pEndPortBeforeNextSpec) {
    return new Immutable(pOutPort, pNextSpec, pEndPortBeforeNextSpec);
  }
  
  private static final class Mutable extends FirstOutPortFromBusSpecificationMatch {
  ...
  private static final class Immutable extends FirstOutPortFromBusSpecificationMatch {
