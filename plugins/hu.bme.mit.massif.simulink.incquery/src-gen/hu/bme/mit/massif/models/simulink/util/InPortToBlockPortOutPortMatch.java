...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.util.inPortToBlockPortOutPort pattern,
...
public abstract class InPortToBlockPortOutPortMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("outPortOfPBl".equals(parameterName) ) {
    	this.fOutPortOfPBl = (hu.bme.mit.massif.simulink.OutPort) newValue;
    	return true;
    }
    return false;
