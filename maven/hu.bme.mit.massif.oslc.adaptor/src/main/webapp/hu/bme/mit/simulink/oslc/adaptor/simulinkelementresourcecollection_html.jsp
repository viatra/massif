...
<%
    List<SimulinkElementResource> resources = (List<SimulinkElementResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>SimulinkElementResource Query</title>
    <%--
...
End of user code 
        ...
        <% for (SimulinkElementResource aSimulinkElementResource : resources) { %>
