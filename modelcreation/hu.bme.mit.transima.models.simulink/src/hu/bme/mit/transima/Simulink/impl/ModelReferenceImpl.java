...
public class ModelReferenceImpl extends BlockImpl implements ModelReference {
    ...
    public SimulinkModel getReferencedModel() {
        SimulinkModel referencedModel = basicGetReferencedModel();
        return referencedModel != null && referencedModel.eIsProxy() ? (SimulinkModel)eResolveProxy((InternalEObject)referencedModel) : referencedModel;
    }
    ...
    public SimulinkModel basicGetReferencedModelGen() {
        // TODO: implement this method to return the 'Referenced Model' reference
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            case SimulinkPackage.MODEL_REFERENCE__REFERENCED_MODEL:
                return basicGetReferencedModel() != null;
            case SimulinkPackage.MODEL_REFERENCE__MODEL_REF:
