...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.util.inPortToInPortConnection pattern,
...
public class InPortToInPortConnectionMatcher extends BaseMatcher<InPortToInPortConnectionMatch> {
  ...
  protected InPortToInPortConnectionMatch tupleToMatch(final Tuple t) {
    try {
    	return InPortToInPortConnectionMatch.newMatch((hu.bme.mit.massif.simulink.InPort) t.get(POSITION_SOURCEINPORT), (hu.bme.mit.massif.simulink.InPort) t.get(POSITION_TARGETINPORT));
  ...
  protected InPortToInPortConnectionMatch arrayToMatch(final Object[] match) {
    try {
    	return InPortToInPortConnectionMatch.newMatch((hu.bme.mit.massif.simulink.InPort) match[POSITION_SOURCEINPORT], (hu.bme.mit.massif.simulink.InPort) match[POSITION_TARGETINPORT]);
    } catch(ClassCastException e) {
  ...
  protected InPortToInPortConnectionMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return InPortToInPortConnectionMatch.newMutableMatch((hu.bme.mit.massif.simulink.InPort) match[POSITION_SOURCEINPORT], (hu.bme.mit.massif.simulink.InPort) match[POSITION_TARGETINPORT]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
