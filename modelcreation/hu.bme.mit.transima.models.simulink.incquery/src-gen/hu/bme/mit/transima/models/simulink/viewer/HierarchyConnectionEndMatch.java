...
/**
 * Pattern-specific match representation of the hu.bme.mit.transima.models.simulink.viewer.hierarchyConnectionEnd pattern,
 * to be used in conjunction with {@link HierarchyConnectionEndMatcher}.
 * 
...
public abstract class HierarchyConnectionEndMatch extends BasePatternMatch {
  private Port fPort;
  ...
  private HierarchyConnectionEndMatch(final Port pPort, final Block pBlock) {
    this.fPort = pPort;
    this.fBlock = pBlock;
  ...
  public List<String> parameterNames() {
    return HierarchyConnectionEndMatch.parameterNames;
  ...
  @Override
  public HierarchyConnectionEndMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof HierarchyConnectionEndMatch)) { // this should be infrequent
    	if (obj == null)
    		return false;
    ...
    HierarchyConnectionEndMatch other = (HierarchyConnectionEndMatch) obj;
  ...
  @Override
  public HierarchyConnectionEndQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static HierarchyConnectionEndMatch newEmptyMatch() {
   ...
   * 
   */
  public static HierarchyConnectionEndMatch newMutableMatch(final Port pPort, final Block pBlock) {
   ...
   * 
   */
  public static HierarchyConnectionEndMatch newMatch(final Port pPort, final Block pBlock) {
    return new Immutable(pPort, pBlock);
    
  }
  
  private static final class Mutable extends HierarchyConnectionEndMatch {
  ...
  private static final class Immutable extends HierarchyConnectionEndMatch {
