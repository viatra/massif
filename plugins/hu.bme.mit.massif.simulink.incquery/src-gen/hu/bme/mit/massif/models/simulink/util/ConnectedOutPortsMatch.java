...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.util.connectedOutPorts pattern,
 * to be used in conjunction with {@link ConnectedOutPortsMatcher}.
 * 
...
public abstract class ConnectedOutPortsMatch extends BasePatternMatch {
  ...
  private ConnectedOutPortsMatch(final OutPort pSourceOutPort, final OutPort pTargetOutPort) {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("sourceOutPort".equals(parameterName) ) {
    	this.fSourceOutPort = (hu.bme.mit.massif.simulink.OutPort) newValue;
    	return true;
    }
    if ("targetOutPort".equals(parameterName) ) {
    	this.fTargetOutPort = (hu.bme.mit.massif.simulink.OutPort) newValue;
    	return true;
    }
    return false;
  ...
  public List<String> parameterNames() {
    return ConnectedOutPortsMatch.parameterNames;
  ...
  @Override
  public ConnectedOutPortsMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ConnectedOutPortsMatch)) { // this should be infrequent
    	if (obj == null)
    		return false;
    ...
    ConnectedOutPortsMatch other = (ConnectedOutPortsMatch) obj;
  ...
  @Override
  public ConnectedOutPortsQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ConnectedOutPortsMatch newEmptyMatch() {
   ...
   * 
   */
  public static ConnectedOutPortsMatch newMutableMatch(final OutPort pSourceOutPort, final OutPort pTargetOutPort) {
   ...
   * 
   */
  public static ConnectedOutPortsMatch newMatch(final OutPort pSourceOutPort, final OutPort pTargetOutPort) {
    return new Immutable(pSourceOutPort, pTargetOutPort);
    
  }
  
  private static final class Mutable extends ConnectedOutPortsMatch {
  ...
  private static final class Immutable extends ConnectedOutPortsMatch {
