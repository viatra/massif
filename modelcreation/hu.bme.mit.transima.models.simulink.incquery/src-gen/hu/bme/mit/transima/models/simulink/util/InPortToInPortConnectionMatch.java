...
/**
 * Pattern-specific match representation of the hu.bme.mit.transima.models.simulink.util.inPortToInPortConnection pattern,
 * to be used in conjunction with {@link InPortToInPortConnectionMatcher}.
 * 
...
public abstract class InPortToInPortConnectionMatch extends BasePatternMatch {
  ...
  private InPortToInPortConnectionMatch(final InPort pSourceInPort, final InPort pTargetInPort) {
  ...
  public List<String> parameterNames() {
    return InPortToInPortConnectionMatch.parameterNames;
  ...
  public InPortToInPortConnectionMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof InPortToInPortConnectionMatch)) { // this should be infrequent
    	if (obj == null)
    		return false;
    ...
    InPortToInPortConnectionMatch other = (InPortToInPortConnectionMatch) obj;
  ...
  public InPortToInPortConnectionQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static InPortToInPortConnectionMatch newEmptyMatch() {
   ...
   * 
   */
  public static InPortToInPortConnectionMatch newMutableMatch(final InPort pSourceInPort, final InPort pTargetInPort) {
   ...
   * 
   */
  public static InPortToInPortConnectionMatch newMatch(final InPort pSourceInPort, final InPort pTargetInPort) {
    return new Immutable(pSourceInPort, pTargetInPort);
    
  }
  
  private static final class Mutable extends InPortToInPortConnectionMatch {
  ...
  private static final class Immutable extends InPortToInPortConnectionMatch {
