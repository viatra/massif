...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.validation.clashingChildNames pattern,
...
public abstract class ClashingChildNamesMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("parent".equals(parameterName) ) {
    	this.fParent = (hu.bme.mit.massif.simulink.SimulinkElement) newValue;
    	return true;
    }
