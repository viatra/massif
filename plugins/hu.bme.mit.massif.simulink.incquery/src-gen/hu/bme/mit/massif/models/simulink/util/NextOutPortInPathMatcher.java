...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.util.nextOutPortInPath pattern,
...
public class NextOutPortInPathMatcher extends BaseMatcher<NextOutPortInPathMatch> {
  ...
  public Set<OutPort> getAllValuesOfnextOutPort(final OutPort pSourceOutPort, final OutPort pTargetOutPort) {
    return rawAccumulateAllValuesOfnextOutPort(new Object[]{
    pSourceOutPort, 
    null, 
    pTargetOutPort
    });
  ...
  protected NextOutPortInPathMatch tupleToMatch(final Tuple t) {
    try {
    	return NextOutPortInPathMatch.newMatch((hu.bme.mit.massif.simulink.OutPort) t.get(POSITION_SOURCEOUTPORT), (hu.bme.mit.massif.simulink.OutPort) t.get(POSITION_NEXTOUTPORT), (hu.bme.mit.massif.simulink.OutPort) t.get(POSITION_TARGETOUTPORT));
  ...
  protected NextOutPortInPathMatch arrayToMatch(final Object[] match) {
    try {
    	return NextOutPortInPathMatch.newMatch((hu.bme.mit.massif.simulink.OutPort) match[POSITION_SOURCEOUTPORT], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_NEXTOUTPORT], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_TARGETOUTPORT]);
    } catch(ClassCastException e) {
  ...
  protected NextOutPortInPathMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return NextOutPortInPathMatch.newMutableMatch((hu.bme.mit.massif.simulink.OutPort) match[POSITION_SOURCEOUTPORT], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_NEXTOUTPORT], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_TARGETOUTPORT]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
