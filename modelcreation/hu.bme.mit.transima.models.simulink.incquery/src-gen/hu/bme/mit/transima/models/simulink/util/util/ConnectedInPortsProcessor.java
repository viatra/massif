...
/**
 * A match processor tailored for the hu.bme.mit.transima.models.simulink.util.connectedInPorts pattern.
 * 
...
public abstract class ConnectedInPortsProcessor implements IMatchProcessor<ConnectedInPortsMatch> {
  ...
  @Override
  public void process(final ConnectedInPortsMatch match) {
