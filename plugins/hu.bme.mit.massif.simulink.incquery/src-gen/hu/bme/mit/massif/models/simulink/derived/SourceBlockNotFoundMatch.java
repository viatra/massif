...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.derived.sourceBlockNotFound pattern,
...
public abstract class SourceBlockNotFoundMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("BlRef".equals(parameterName) ) {
    	this.fBlRef = (hu.bme.mit.massif.simulink.LibraryLinkReference) newValue;
    	return true;
    }
    return false;
