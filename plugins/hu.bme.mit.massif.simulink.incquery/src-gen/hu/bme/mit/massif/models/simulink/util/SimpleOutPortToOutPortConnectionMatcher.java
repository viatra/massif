...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.util.simpleOutPortToOutPortConnection pattern,
...
public class SimpleOutPortToOutPortConnectionMatcher extends BaseMatcher<SimpleOutPortToOutPortConnectionMatch> {
  ...
  protected SimpleOutPortToOutPortConnectionMatch tupleToMatch(final Tuple t) {
    try {
    	return SimpleOutPortToOutPortConnectionMatch.newMatch((hu.bme.mit.massif.simulink.OutPort) t.get(POSITION_SOURCEOUTPORT), (hu.bme.mit.massif.simulink.OutPort) t.get(POSITION_TARGETOUTPORT), (hu.bme.mit.massif.simulink.SingleConnection) t.get(POSITION_CONNECTION));
  ...
  protected SimpleOutPortToOutPortConnectionMatch arrayToMatch(final Object[] match) {
    try {
    	return SimpleOutPortToOutPortConnectionMatch.newMatch((hu.bme.mit.massif.simulink.OutPort) match[POSITION_SOURCEOUTPORT], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_TARGETOUTPORT], (hu.bme.mit.massif.simulink.SingleConnection) match[POSITION_CONNECTION]);
    } catch(ClassCastException e) {
  ...
  protected SimpleOutPortToOutPortConnectionMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return SimpleOutPortToOutPortConnectionMatch.newMutableMatch((hu.bme.mit.massif.simulink.OutPort) match[POSITION_SOURCEOUTPORT], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_TARGETOUTPORT], (hu.bme.mit.massif.simulink.SingleConnection) match[POSITION_CONNECTION]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
