...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.util.outPortToOutPortConnection pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link OutPortToOutPortConnectionMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see OutPortToOutPortConnectionQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class OutPortToOutPortConnectionMatcher extends BaseMatcher<OutPortToOutPortConnectionMatch> {
  /**
   ...
   * 
   */
  public static OutPortToOutPortConnectionMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    OutPortToOutPortConnectionMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new OutPortToOutPortConnectionMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(OutPortToOutPortConnectionMatcher.class);
   ...
   * @return matches represented as a OutPortToOutPortConnectionMatch object.
   * 
   */
  public Collection<OutPortToOutPortConnectionMatch> getAllMatches(final OutPort pSourceOutPort, final OutPort pTargetOutPort) {
   ...
   * @param pSourceOutPort the fixed value of pattern parameter sourceOutPort, or null if not bound.
   * @param pTargetOutPort the fixed value of pattern parameter targetOutPort, or null if not bound.
   * @return a match represented as a OutPortToOutPortConnectionMatch object, or null if no match is found.
   * 
   */
  public OutPortToOutPortConnectionMatch getOneArbitraryMatch(final OutPort pSourceOutPort, final OutPort pTargetOutPort) {
   ...
   * 
   */
  public void forEachMatch(final OutPort pSourceOutPort, final OutPort pTargetOutPort, final IMatchProcessor<? super OutPortToOutPortConnectionMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final OutPort pSourceOutPort, final OutPort pTargetOutPort, final IMatchProcessor<? super OutPortToOutPortConnectionMatch> processor) {
   ...
   * 
   */
  public OutPortToOutPortConnectionMatch newMatch(final OutPort pSourceOutPort, final OutPort pTargetOutPort) {
    return OutPortToOutPortConnectionMatch.newMatch(pSourceOutPort, pTargetOutPort);
  }
   ...
   * 
   */
  public Set<OutPort> getAllValuesOfsourceOutPort(final OutPortToOutPortConnectionMatch partialMatch) {
   ...
   * 
   */
  public Set<OutPort> getAllValuesOftargetOutPort(final OutPortToOutPortConnectionMatch partialMatch) {
  ...
  protected OutPortToOutPortConnectionMatch tupleToMatch(final Tuple t) {
    try {
    	return OutPortToOutPortConnectionMatch.newMatch((hu.bme.mit.massif.simulink.OutPort) t.get(POSITION_SOURCEOUTPORT), (hu.bme.mit.massif.simulink.OutPort) t.get(POSITION_TARGETOUTPORT));
  ...
  protected OutPortToOutPortConnectionMatch arrayToMatch(final Object[] match) {
    try {
    	return OutPortToOutPortConnectionMatch.newMatch((hu.bme.mit.massif.simulink.OutPort) match[POSITION_SOURCEOUTPORT], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_TARGETOUTPORT]);
    } catch(ClassCastException e) {
  ...
  protected OutPortToOutPortConnectionMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return OutPortToOutPortConnectionMatch.newMutableMatch((hu.bme.mit.massif.simulink.OutPort) match[POSITION_SOURCEOUTPORT], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_TARGETOUTPORT]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<OutPortToOutPortConnectionMatcher> querySpecification() throws IncQueryException {
