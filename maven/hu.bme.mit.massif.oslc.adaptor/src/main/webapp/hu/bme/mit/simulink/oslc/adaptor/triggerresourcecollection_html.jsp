...
<%
    List<TriggerResource> resources = (List<TriggerResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>TriggerResource Query</title>
    <%--
...
End of user code 
        ...
        <% for (TriggerResource aTriggerResource : resources) { %>
