...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.viewer.fromBlocks pattern,
...
public abstract class FromBlocksMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("bl".equals(parameterName) ) {
    	this.fBl = (hu.bme.mit.massif.simulink.From) newValue;
    	return true;
    }
    return false;
  }
