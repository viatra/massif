...
<%
    List<BusCreatorResource> resources = (List<BusCreatorResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>BusCreatorResource Query</title>
    <%--
...
End of user code 
        ...
        <% for (BusCreatorResource aBusCreatorResource : resources) { %>
