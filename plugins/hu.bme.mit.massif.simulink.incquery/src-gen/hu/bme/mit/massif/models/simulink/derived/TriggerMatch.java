...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.derived.trigger pattern,
...
public abstract class TriggerMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("Trigger".equals(parameterName) ) {
    	this.fTrigger = (hu.bme.mit.massif.simulink.Trigger) newValue;
    	return true;
    }
    return false;
  }
