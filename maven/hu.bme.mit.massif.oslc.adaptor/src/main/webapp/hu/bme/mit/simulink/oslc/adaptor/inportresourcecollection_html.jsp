...
<%
    List<InPortResource> resources = (List<InPortResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>InPortResource Query</title>
    <%--
...
End of user code 
        ...
        <% for (InPortResource aInPortResource : resources) { %>
