...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.util.multiConnection pattern,
 * to be used in conjunction with {@link MultiConnectionMatcher}.
 * 
...
public abstract class MultiConnectionMatch extends BasePatternMatch {
  ...
  private MultiConnectionMatch(final OutPort pOutP, final InPort pInP, final SingleConnection pPc) {
    this.fOutP = pOutP;
    this.fInP = pInP;
    this.fPc = pPc;
  }
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("pc".equals(parameterName) ) {
    	this.fPc = (hu.bme.mit.massif.simulink.SingleConnection) newValue;
    	return true;
    }
    return false;
  }
  ...
  public List<String> parameterNames() {
    return MultiConnectionMatch.parameterNames;
  }
  ...
  @Override
  public MultiConnectionMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MultiConnectionMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    MultiConnectionMatch other = (MultiConnectionMatch) obj;
  ...
  @Override
  public MultiConnectionQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static MultiConnectionMatch newMutableMatch(final OutPort pOutP, final InPort pInP, final SingleConnection pPc) {
   ...
   * 
   */
  public static MultiConnectionMatch newMatch(final OutPort pOutP, final InPort pInP, final SingleConnection pPc) {
    return new Immutable(pOutP, pInP, pPc);
  }
  
  private static final class Mutable extends MultiConnectionMatch {
  ...
  private static final class Immutable extends MultiConnectionMatch {
