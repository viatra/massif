...
/**
 * Pattern-specific match representation of the hu.bme.mit.transima.models.simulink.validation.identifierNameContainsSlash pattern,
...
public abstract class IdentifierNameContainsSlashMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("id".equals(parameterName) ) {
    	this.fId = (hu.bme.mit.transima.Simulink.IdentifierReference) newValue;
    	return true;
    }
    return false;
