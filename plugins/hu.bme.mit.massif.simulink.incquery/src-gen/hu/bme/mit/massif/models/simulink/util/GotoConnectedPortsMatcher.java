...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.util.gotoConnectedPorts pattern,
...
public class GotoConnectedPortsMatcher extends BaseMatcher<GotoConnectedPortsMatch> {
  ...
  public Set<InPort> getAllValuesOfgotoInPort(final OutPort pFromOutPort) {
    return rawAccumulateAllValuesOfgotoInPort(new Object[]{
    null, 
    pFromOutPort
    });
  }
  ...
  public Set<OutPort> getAllValuesOffromOutPort(final InPort pGotoInPort) {
    return rawAccumulateAllValuesOffromOutPort(new Object[]{
    pGotoInPort, 
    null
    });
  }
  ...
  protected GotoConnectedPortsMatch tupleToMatch(final Tuple t) {
    try {
    	return GotoConnectedPortsMatch.newMatch((hu.bme.mit.massif.simulink.InPort) t.get(POSITION_GOTOINPORT), (hu.bme.mit.massif.simulink.OutPort) t.get(POSITION_FROMOUTPORT));
  ...
  protected GotoConnectedPortsMatch arrayToMatch(final Object[] match) {
    try {
    	return GotoConnectedPortsMatch.newMatch((hu.bme.mit.massif.simulink.InPort) match[POSITION_GOTOINPORT], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_FROMOUTPORT]);
    } catch(ClassCastException e) {
  ...
  protected GotoConnectedPortsMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return GotoConnectedPortsMatch.newMutableMatch((hu.bme.mit.massif.simulink.InPort) match[POSITION_GOTOINPORT], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_FROMOUTPORT]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
