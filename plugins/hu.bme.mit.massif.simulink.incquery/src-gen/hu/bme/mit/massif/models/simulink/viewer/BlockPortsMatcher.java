...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.viewer.blockPorts pattern,
...
public class BlockPortsMatcher extends BaseMatcher<BlockPortsMatch> {
  ...
  protected BlockPortsMatch tupleToMatch(final Tuple t) {
    try {
    	return BlockPortsMatch.newMatch((hu.bme.mit.massif.simulink.Block) t.get(POSITION_BLOCK), (hu.bme.mit.massif.simulink.Port) t.get(POSITION_PORT));
  ...
  protected BlockPortsMatch arrayToMatch(final Object[] match) {
    try {
    	return BlockPortsMatch.newMatch((hu.bme.mit.massif.simulink.Block) match[POSITION_BLOCK], (hu.bme.mit.massif.simulink.Port) match[POSITION_PORT]);
    } catch(ClassCastException e) {
  ...
  protected BlockPortsMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return BlockPortsMatch.newMutableMatch((hu.bme.mit.massif.simulink.Block) match[POSITION_BLOCK], (hu.bme.mit.massif.simulink.Port) match[POSITION_PORT]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
