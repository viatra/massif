...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.viewer.emptySubSystem pattern,
...
public abstract class EmptySubSystemMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("subS".equals(parameterName) ) {
    	this.fSubS = (hu.bme.mit.massif.simulink.SubSystem) newValue;
    	return true;
    }
    return false;
  }
