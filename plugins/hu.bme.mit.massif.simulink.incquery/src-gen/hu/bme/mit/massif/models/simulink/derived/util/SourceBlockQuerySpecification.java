...
public final class SourceBlockQuerySpecification extends BaseGeneratedEMFQuerySpecification<SourceBlockMatcher> {
  private SourceBlockQuerySpecification() {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static SourceBlockQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new PositivePatternCall(body, new FlatTuple(var_SrcRef, var_SR), ReferenceEqualQuerySpecification.instance().getInternalQueryRepresentation());
      	bodies.add(body);
      }
      	{
