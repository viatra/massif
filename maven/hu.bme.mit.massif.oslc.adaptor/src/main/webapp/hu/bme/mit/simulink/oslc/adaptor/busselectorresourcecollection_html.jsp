...
<%
    List<BusSelectorResource> resources = (List<BusSelectorResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>BusSelectorResource Query</title>
    <%--
...
End of user code 
        ...
        <% for (BusSelectorResource aBusSelectorResource : resources) { %>
