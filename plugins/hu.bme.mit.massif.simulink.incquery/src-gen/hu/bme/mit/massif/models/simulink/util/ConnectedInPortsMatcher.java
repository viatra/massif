...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.util.connectedInPorts pattern,
...
public class ConnectedInPortsMatcher extends BaseMatcher<ConnectedInPortsMatch> {
  ...
  protected ConnectedInPortsMatch tupleToMatch(final Tuple t) {
    try {
    	return ConnectedInPortsMatch.newMatch((hu.bme.mit.massif.simulink.InPort) t.get(POSITION_SOURCEINPORT), (hu.bme.mit.massif.simulink.InPort) t.get(POSITION_TARGETINPORT));
  ...
  protected ConnectedInPortsMatch arrayToMatch(final Object[] match) {
    try {
    	return ConnectedInPortsMatch.newMatch((hu.bme.mit.massif.simulink.InPort) match[POSITION_SOURCEINPORT], (hu.bme.mit.massif.simulink.InPort) match[POSITION_TARGETINPORT]);
    } catch(ClassCastException e) {
  ...
  protected ConnectedInPortsMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return ConnectedInPortsMatch.newMutableMatch((hu.bme.mit.massif.simulink.InPort) match[POSITION_SOURCEINPORT], (hu.bme.mit.massif.simulink.InPort) match[POSITION_TARGETINPORT]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
