...
@Path("simulinkModelResources")
public class SimulinkModelResourceService {
    @Context
    ...
    public SimulinkModelResourceService() {
        super();
    }
    ...
    public SimulinkModelResource[] getSimulinkModelResources(

    @QueryParam("oslc.where") final String where, @QueryParam("page") final String pageString) throws IOException,
            ServletException {
        int page = 0;
        int limit = 999;
        ...
        final List<SimulinkModelResource> resources = SimulinkAdaptorManager.getSimulinkModelResources(
                httpServletRequest, page, limit);
        return resources.toArray(new SimulinkModelResource[resources.size()]);
    ...
    public Response getSimulinkModelResourcesAsHtml(
    ...
    @QueryParam("page") final String pageString) throws ServletException, IOException {
        ...
        if (resources != null) {
            ...
            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/simulinkmodelresourcecollection_html.jsp");
    ...
    @Path("{simulinkModel}")
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public SimulinkModelResource getSimulinkModelResource(@PathParam("simulinkModel") final String simulinkModel)
            throws IOException, ServletException, URISyntaxException {
        // Start of user code (MUST_FILL_IN) getResource_init
        // End of user code

        final SimulinkModelResource aSimulinkModelResource = SimulinkAdaptorManager.getSimulinkModelResource(
                httpServletRequest, simulinkModel);

        if (aSimulinkModelResource != null) {
    ...
    @Path("{simulinkModel}")
    @Produces({ MediaType.TEXT_HTML })
    public Response getSimulinkModelResourceAsHtml(@PathParam("simulinkModel") final String simulinkModel)
        ...
        if (aSimulinkModelResource != null) {
            httpServletRequest.setAttribute("aSimulinkModelResource", aSimulinkModelResource);
            // Start of user code getResourceAsHTML_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/simulinkmodelresource_html.jsp");
    ...
    public void simulinkModelResourceSelector(@QueryParam("terms") final String terms
        ...
        try {
            ...
            if (terms != null) {
                ...
                final List<SimulinkModelResource> resources = SimulinkAdaptorManager.searchSimulinkModelResources(
                        httpServletRequest, terms);
                if (resources != null) {
                    httpServletRequest.setAttribute("resources", resources);
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/simulinkmodelresourcefilteredcollection_json.jsp");
                ...
                try {
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/simulinkmodelresourceselector_html.jsp");
    ...
    public void simulinkModelResourceCreatorAsHtml(
        ...
        RequestDispatcher rd = httpServletRequest
                .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/simulinkmodelresourcecreator_html.jsp");
    ...
    public void createSimulinkModelResourceFromHtml(

    ) {
        try {
            SimulinkModelResource aSimulinkModelResource = new SimulinkModelResource();

            String[] paramValues;

            paramValues = httpServletRequest.getParameterValues("library");
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aSimulinkModelResource.setLibrary(new Boolean(paramValues[0]));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }

            }
            paramValues = httpServletRequest.getParameterValues("file");
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aSimulinkModelResource.setFile(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }

            }
            paramValues = httpServletRequest.getParameterValues("contains");
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aSimulinkModelResource.addContains(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aSimulinkModelResource.setName(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aSimulinkModelResource.setVersion(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aSimulinkModelResource.setSimulinkRef(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            final SimulinkModelResource newSimulinkModelResource = SimulinkAdaptorManager.createSimulinkModelResource(
                    httpServletRequest, aSimulinkModelResource);

            httpServletRequest.setAttribute("newResource", newSimulinkModelResource);
            httpServletRequest.setAttribute("newResourceUri", newSimulinkModelResource.getAbout().toString());

            // Send back to the form a small JSON response
            httpServletResponse.setContentType("application/json");
            httpServletResponse.setStatus(Status.CREATED.getStatusCode());
            httpServletResponse.addHeader("Location", newSimulinkModelResource.getAbout().toString());
            PrintWriter out = httpServletResponse.getWriter();
            out.print("{" + "\"resource\" : \"" + newSimulinkModelResource.getAbout().toString() + "\"}");
            out.close();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
    ...
    @OslcCreationFactory(title = "DO_NOT_USE", label = "DO_NOT_USE", resourceShapes = { OslcConstants.PATH_RESOURCE_SHAPES
            + "/" + SimulinkAdaptorConstants.PATH_SIMULINKMODELRESOURCE }, resourceTypes = {
    ...
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public Response createSimulinkModelResource(

    final SimulinkModelResource aSimulinkModelResource) throws IOException, ServletException {
        try {
            SimulinkModelResource newSimulinkModelResource = SimulinkAdaptorManager.createSimulinkModelResource(
                    httpServletRequest, aSimulinkModelResource);
            httpServletResponse.setHeader("ETag",
                    SimulinkAdaptorManager.getETagFromSimulinkModelResource(newSimulinkModelResource));
            return Response.created(newSimulinkModelResource.getAbout()).entity(aSimulinkModelResource).build();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
        }
