...
<%
    List<BusSpecificationResource> resources = (List<BusSpecificationResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>BusSpecificationResource Query</title>
    <%--
...
<div id="header">
    ...
    <table border="0" cellspacing="0" cellpadding="0" id="titles">
        <tr>
            <td id="title">
                <p>
                    BusSpecificationResource Query
                </p>
            </td>
            <td id="information">
...
End of user code 
        ...
        <% for (BusSpecificationResource aBusSpecificationResource : resources) { %>
