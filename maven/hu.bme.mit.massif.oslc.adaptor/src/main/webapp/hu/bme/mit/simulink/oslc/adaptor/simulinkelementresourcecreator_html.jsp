...
End of user code 
        ...
        <table style="clear: both;">
            ...
            <tr>
                <td><%= SimulinkElementResource.nameToHtmlForCreation(request, serviceProviderId)%>
                </td>
            </tr>
            <tr>
                <td><%= SimulinkElementResource.simulinkRefToHtmlForCreation(request, serviceProviderId)%>
                </td>
            </tr>
