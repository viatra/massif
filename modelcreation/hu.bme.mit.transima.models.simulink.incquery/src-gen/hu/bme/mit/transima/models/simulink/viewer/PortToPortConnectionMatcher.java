...
/**
 * Generated pattern matcher API of the hu.bme.mit.transima.models.simulink.viewer.portToPortConnection pattern,
...
public class PortToPortConnectionMatcher extends BaseMatcher<PortToPortConnectionMatch> {
  ...
  public Set<Block> getAllValuesOffrom(final Block pTo, final String pName) {
    return rawAccumulateAllValuesOffrom(new Object[]{null, pTo, pName});
  }
  ...
  public Set<Block> getAllValuesOfto(final Block pFrom, final String pName) {
    return rawAccumulateAllValuesOfto(new Object[]{pFrom, null, pName});
  }
