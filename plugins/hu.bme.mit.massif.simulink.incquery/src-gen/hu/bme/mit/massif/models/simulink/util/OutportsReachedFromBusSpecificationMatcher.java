...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.util.outportsReachedFromBusSpecification pattern,
...
public class OutportsReachedFromBusSpecificationMatcher extends BaseMatcher<OutportsReachedFromBusSpecificationMatch> {
  ...
  protected OutportsReachedFromBusSpecificationMatch tupleToMatch(final Tuple t) {
    try {
    	return OutportsReachedFromBusSpecificationMatch.newMatch((hu.bme.mit.massif.simulink.OutPort) t.get(POSITION_OUTPORT), (hu.bme.mit.massif.simulink.BusSpecification) t.get(POSITION_NEXTSPEC), (hu.bme.mit.massif.simulink.OutPort) t.get(POSITION_ENDPORTBEFORENEXTSPEC));
  ...
  protected OutportsReachedFromBusSpecificationMatch arrayToMatch(final Object[] match) {
    try {
    	return OutportsReachedFromBusSpecificationMatch.newMatch((hu.bme.mit.massif.simulink.OutPort) match[POSITION_OUTPORT], (hu.bme.mit.massif.simulink.BusSpecification) match[POSITION_NEXTSPEC], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_ENDPORTBEFORENEXTSPEC]);
    } catch(ClassCastException e) {
  ...
  protected OutportsReachedFromBusSpecificationMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return OutportsReachedFromBusSpecificationMatch.newMutableMatch((hu.bme.mit.massif.simulink.OutPort) match[POSITION_OUTPORT], (hu.bme.mit.massif.simulink.BusSpecification) match[POSITION_NEXTSPEC], (hu.bme.mit.massif.simulink.OutPort) match[POSITION_ENDPORTBEFORENEXTSPEC]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
