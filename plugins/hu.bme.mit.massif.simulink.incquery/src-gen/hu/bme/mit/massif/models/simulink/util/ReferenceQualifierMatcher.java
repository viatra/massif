...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.util.referenceQualifier pattern,
...
public class ReferenceQualifierMatcher extends BaseMatcher<ReferenceQualifierMatch> {
  ...
  public Set<SimulinkReference> getAllValuesOfSR(final String pQual) {
    return rawAccumulateAllValuesOfSR(new Object[]{
    null, 
    pQual
    });
  }
  ...
  public Set<String> getAllValuesOfQual(final SimulinkReference pSR) {
    return rawAccumulateAllValuesOfQual(new Object[]{
    pSR, 
    null
    });
  }
  ...
  protected ReferenceQualifierMatch tupleToMatch(final Tuple t) {
    try {
    	return ReferenceQualifierMatch.newMatch((hu.bme.mit.massif.simulink.SimulinkReference) t.get(POSITION_SR), (java.lang.String) t.get(POSITION_QUAL));
  ...
  protected ReferenceQualifierMatch arrayToMatch(final Object[] match) {
    try {
    	return ReferenceQualifierMatch.newMatch((hu.bme.mit.massif.simulink.SimulinkReference) match[POSITION_SR], (java.lang.String) match[POSITION_QUAL]);
    } catch(ClassCastException e) {
  ...
  protected ReferenceQualifierMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return ReferenceQualifierMatch.newMutableMatch((hu.bme.mit.massif.simulink.SimulinkReference) match[POSITION_SR], (java.lang.String) match[POSITION_QUAL]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
