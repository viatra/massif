...
/**
 * Generated pattern matcher API of the hu.bme.mit.transima.models.simulink.util.referenceEqual pattern,
...
public class ReferenceEqualMatcher extends BaseMatcher<ReferenceEqualMatch> {
  ...
  public Set<SimulinkReference> getAllValuesOfsourceRef(final SimulinkReference pTargetRef) {
    return rawAccumulateAllValuesOfsourceRef(new Object[]{null, pTargetRef});
  }
