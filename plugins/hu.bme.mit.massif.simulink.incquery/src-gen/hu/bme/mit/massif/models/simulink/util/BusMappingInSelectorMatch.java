...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.util.busMappingInSelector pattern,
...
public abstract class BusMappingInSelectorMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("mapping".equals(parameterName) ) {
    	this.fMapping = (hu.bme.mit.massif.simulink.BusSignalMapping) newValue;
    	return true;
    }
    if ("mappingFrom".equals(parameterName) ) {
    	this.fMappingFrom = (hu.bme.mit.massif.simulink.OutPort) newValue;
    	return true;
    }
    if ("mappingTo".equals(parameterName) ) {
    	this.fMappingTo = (hu.bme.mit.massif.simulink.OutPort) newValue;
    	return true;
    }
    return false;
  }
