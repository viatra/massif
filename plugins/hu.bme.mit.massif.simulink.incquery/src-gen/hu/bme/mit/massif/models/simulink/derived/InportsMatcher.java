...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.derived.inports pattern,
...
public class InportsMatcher extends BaseMatcher<InportsMatch> {
  ...
  protected InportsMatch tupleToMatch(final Tuple t) {
    try {
    	return InportsMatch.newMatch((hu.bme.mit.massif.simulink.Block) t.get(POSITION_BLOCK), (hu.bme.mit.massif.simulink.InPort) t.get(POSITION_INPORT));
  ...
  protected InportsMatch arrayToMatch(final Object[] match) {
    try {
    	return InportsMatch.newMatch((hu.bme.mit.massif.simulink.Block) match[POSITION_BLOCK], (hu.bme.mit.massif.simulink.InPort) match[POSITION_INPORT]);
    } catch(ClassCastException e) {
  ...
  protected InportsMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return InportsMatch.newMutableMatch((hu.bme.mit.massif.simulink.Block) match[POSITION_BLOCK], (hu.bme.mit.massif.simulink.InPort) match[POSITION_INPORT]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
