...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.util.elementName pattern,
 * to be used in conjunction with {@link ElementNameMatcher}.
 * 
...
public abstract class ElementNameMatch extends BasePatternMatch {
  ...
  private ElementNameMatch(final SimulinkElement pSE, final String pName) {
    this.fSE = pSE;
    this.fName = pName;
  }
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("SE".equals(parameterName) ) {
    	this.fSE = (hu.bme.mit.massif.simulink.SimulinkElement) newValue;
    	return true;
    }
  ...
  public List<String> parameterNames() {
    return ElementNameMatch.parameterNames;
  }
  ...
  @Override
  public ElementNameMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ElementNameMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ElementNameMatch other = (ElementNameMatch) obj;
  ...
  @Override
  public ElementNameQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ElementNameMatch newMutableMatch(final SimulinkElement pSE, final String pName) {
   ...
   * 
   */
  public static ElementNameMatch newMatch(final SimulinkElement pSE, final String pName) {
    return new Immutable(pSE, pName);
  }
  
  private static final class Mutable extends ElementNameMatch {
  ...
  private static final class Immutable extends ElementNameMatch {
