 ...
 * <ul>
 *   <li>{@link hu.bme.mit.transima.Simulink.impl.BusSignalMappingImpl#getSelector <em>Selector</em>}</li>
 *   <li>{@link hu.bme.mit.transima.Simulink.impl.BusSignalMappingImpl#getMappingFrom <em>Mapping From</em>}</li>
 *   <li>{@link hu.bme.mit.transima.Simulink.impl.BusSignalMappingImpl#getMappingTo <em>Mapping To</em>}</li>
 *   <li>{@link hu.bme.mit.transima.Simulink.impl.BusSignalMappingImpl#getMappingPath <em>Mapping Path</em>}</li>
 *   <li>{@link hu.bme.mit.transima.Simulink.impl.BusSignalMappingImpl#isIncomplete <em>Incomplete</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
