...
public final class SimulinkUtilities extends BaseGeneratedPatternGroup {
  ...
  private SimulinkUtilities() throws IncQueryException {
    ...
    querySpecifications.add(ElementNameQuerySpecification.instance());
  }
  ...
  public ElementNameMatcher getElementName(final IncQueryEngine engine) throws IncQueryException {
