...
@Path("/simu/{serviceProviderId}/enableResources")
public class EnableResourceService {
    @Context
    ...
    public EnableResource[] getEnableResources(@PathParam("serviceProviderId") final String serviceProviderId,
        ...
        final List<EnableResource> resources = SimulinkAdaptorManager.getEnableResources(httpServletRequest,
                serviceProviderId, page, limit);
        return resources.toArray(new EnableResource[resources.size()]);
    ...
    public Response getEnableResourcesAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
        ...
        if (resources != null) {
            ...
            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/enableresourcecollection_html.jsp");
    ...
    @Path("{enable}")
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public EnableResource getEnableResource(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("enable") final String enable) throws IOException, ServletException, URISyntaxException {
        // Start of user code (MUST_FILL_IN) getResource_init
        // End of user code

        final EnableResource aEnableResource = SimulinkAdaptorManager.getEnableResource(httpServletRequest,
                serviceProviderId, enable);

        if (aEnableResource != null) {
    ...
    @Path("{enable}")
    @Produces({ MediaType.TEXT_HTML })
    public Response getEnableResourceAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("enable") final String enable) throws ServletException, IOException, URISyntaxException {
        ...
        if (aEnableResource != null) {
            httpServletRequest.setAttribute("aEnableResource", aEnableResource);
            // Start of user code getResourceAsHTML_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/enableresource_html.jsp");
    ...
    public void enableResourceSelector(@QueryParam("terms") final String terms,
        ...
        try {
            ...
            if (terms != null) {
                ...
                final List<EnableResource> resources = SimulinkAdaptorManager.searchEnableResources(httpServletRequest,
                        serviceProviderId, terms);
                if (resources != null) {
                    httpServletRequest.setAttribute("resources", resources);
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/enableresourcefilteredcollection_json.jsp");
                ...
                try {
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/enableresourceselector_html.jsp");
    ...
    public void enableResourceCreatorAsHtml(@PathParam("serviceProviderId") final String serviceProviderId)
            throws IOException, ServletException {
        ...
        RequestDispatcher rd = httpServletRequest
                .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/enableresourcecreator_html.jsp");
    ...
    public void createEnableResourceFromHtml(@PathParam("serviceProviderId") final String serviceProviderId) {
        try {
            EnableResource aEnableResource = new EnableResource();
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aEnableResource.setStatesWhenEnabling(paramValues[0]);
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aEnableResource.addConnections(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aEnableResource.setContainer(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aEnableResource.setPortBlock(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aEnableResource.setName(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aEnableResource.setSimulinkRef(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            final EnableResource newEnableResource = SimulinkAdaptorManager.createEnableResource(httpServletRequest,
                    aEnableResource, serviceProviderId);

            httpServletRequest.setAttribute("newResource", newEnableResource);
            httpServletRequest.setAttribute("newResourceUri", newEnableResource.getAbout().toString());

            // Send back to the form a small JSON response
            httpServletResponse.setContentType("application/json");
            httpServletResponse.setStatus(Status.CREATED.getStatusCode());
            httpServletResponse.addHeader("Location", newEnableResource.getAbout().toString());
            PrintWriter out = httpServletResponse.getWriter();
            out.print("{" + "\"resource\" : \"" + newEnableResource.getAbout().toString() + "\"}");
            out.close();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
    ...
    @OslcCreationFactory(title = "DO_NOT_USE", label = "DO_NOT_USE", resourceShapes = { OslcConstants.PATH_RESOURCE_SHAPES
            + "/" + SimulinkAdaptorConstants.PATH_ENABLERESOURCE }, resourceTypes = {
    ...
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public Response createEnableResource(@PathParam("serviceProviderId") final String serviceProviderId,
            final EnableResource aEnableResource) throws IOException, ServletException {
        try {
            EnableResource newEnableResource = SimulinkAdaptorManager.createEnableResource(httpServletRequest,
                    aEnableResource, serviceProviderId);
            httpServletResponse.setHeader("ETag", SimulinkAdaptorManager.getETagFromEnableResource(newEnableResource));
            return Response.created(newEnableResource.getAbout()).entity(aEnableResource).build();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
        }
