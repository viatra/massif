...
public final class SimulinkReferenceQuerySpecification extends BaseGeneratedEMFQuerySpecification<SimulinkReferenceMatcher> {
  private SimulinkReferenceQuerySpecification() {
  ...
  public SimulinkReferenceMatch newMatch(final Object... parameters) {
    return SimulinkReferenceMatch.newMatch((hu.bme.mit.massif.simulink.SimulinkReference) parameters[0], (java.lang.String) parameters[1], (java.lang.String) parameters[2]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static SimulinkReferenceQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("SR", "hu.bme.mit.massif.simulink.SimulinkReference"),new PParameter("Name", "java.lang.String"),new PParameter("Qual", "java.lang.String"));
    }
