...
/**
 * Pattern-specific match representation of the hu.bme.mit.transima.models.simulink.util.childBlockNames pattern,
...
public abstract class ChildBlockNamesMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("elem".equals(parameterName) ) {
    	this.fElem = (hu.bme.mit.transima.Simulink.SimulinkElement) newValue;
    	return true;
    }
