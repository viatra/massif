...
/**
 * Pattern-specific match representation of the hu.bme.mit.transima.models.simulink.util.portBlockInPortToOutPort pattern,
...
public abstract class PortBlockInPortToOutPortMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("inPortOfPBl".equals(parameterName) ) {
    	this.fInPortOfPBl = (hu.bme.mit.transima.Simulink.InPort) newValue;
    	return true;
    }
