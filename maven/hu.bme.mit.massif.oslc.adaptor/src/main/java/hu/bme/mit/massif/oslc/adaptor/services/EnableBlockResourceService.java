...
@Path("/simu/{serviceProviderId}/enableBlockResources")
public class EnableBlockResourceService {
    @Context
    ...
    public EnableBlockResourceService() {
        super();
    }
    ...
    public EnableBlockResource[] getEnableBlockResources(
        ...
        final List<EnableBlockResource> resources = SimulinkAdaptorManager.getEnableBlockResources(httpServletRequest,
                serviceProviderId, page, limit);
        return resources.toArray(new EnableBlockResource[resources.size()]);
    ...
    public Response getEnableBlockResourcesAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
        ...
        if (resources != null) {
            ...
            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/enableblockresourcecollection_html.jsp");
    ...
    @Path("{enableBlock}")
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public EnableBlockResource getEnableBlockResource(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("enableBlock") final String enableBlock) throws IOException, ServletException,
            URISyntaxException {
        // Start of user code (MUST_FILL_IN) getResource_init
        // End of user code

        final EnableBlockResource aEnableBlockResource = SimulinkAdaptorManager.getEnableBlockResource(
                httpServletRequest, serviceProviderId, enableBlock);

        if (aEnableBlockResource != null) {
    ...
    @Path("{enableBlock}")
    @Produces({ MediaType.TEXT_HTML })
    public Response getEnableBlockResourceAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("enableBlock") final String enableBlock) throws ServletException, IOException,
            URISyntaxException {
        ...
        if (aEnableBlockResource != null) {
            httpServletRequest.setAttribute("aEnableBlockResource", aEnableBlockResource);
            // Start of user code getResourceAsHTML_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/enableblockresource_html.jsp");
    ...
    public void enableBlockResourceSelector(@QueryParam("terms") final String terms,
        ...
        try {
            ...
            if (terms != null) {
                ...
                final List<EnableBlockResource> resources = SimulinkAdaptorManager.searchEnableBlockResources(
                        httpServletRequest, serviceProviderId, terms);
                if (resources != null) {
                    httpServletRequest.setAttribute("resources", resources);
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/enableblockresourcefilteredcollection_json.jsp");
                ...
                try {
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/enableblockresourceselector_html.jsp");
    ...
    public void enableBlockResourceCreatorAsHtml(@PathParam("serviceProviderId") final String serviceProviderId)
            throws IOException, ServletException {
        ...
        RequestDispatcher rd = httpServletRequest
                .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/enableblockresourcecreator_html.jsp");
    ...
    public void createEnableBlockResourceFromHtml(@PathParam("serviceProviderId") final String serviceProviderId) {
        try {
            EnableBlockResource aEnableBlockResource = new EnableBlockResource();
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aEnableBlockResource.setSourceBlock(new Link(new URI(paramValues[0])));
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aEnableBlockResource.setPort(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aEnableBlockResource.setTrigger(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aEnableBlockResource.addPorts(new Link(new URI(paramValues[i])));
                }
            }
            paramValues = httpServletRequest.getParameterValues("property");
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aEnableBlockResource.addProperty(paramValues[i]);
                }
            }
            paramValues = httpServletRequest.getParameterValues("inports");
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aEnableBlockResource.addInports(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aEnableBlockResource.setParent(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aEnableBlockResource.setName(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aEnableBlockResource.setEnabler(new Link(new URI(paramValues[0])));
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            if (paramValues != null) {
                for (int i = 0; i < paramValues.length; i++) {
                    aEnableBlockResource.addOutports(new Link(new URI(paramValues[i])));
                }
            }
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aEnableBlockResource.setSimulinkRef(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            final EnableBlockResource newEnableBlockResource = SimulinkAdaptorManager.createEnableBlockResource(
                    httpServletRequest, aEnableBlockResource, serviceProviderId);

            httpServletRequest.setAttribute("newResource", newEnableBlockResource);
            httpServletRequest.setAttribute("newResourceUri", newEnableBlockResource.getAbout().toString());

            // Send back to the form a small JSON response
            httpServletResponse.setContentType("application/json");
            httpServletResponse.setStatus(Status.CREATED.getStatusCode());
            httpServletResponse.addHeader("Location", newEnableBlockResource.getAbout().toString());
            PrintWriter out = httpServletResponse.getWriter();
            out.print("{" + "\"resource\" : \"" + newEnableBlockResource.getAbout().toString() + "\"}");
            out.close();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
    ...
    @OslcCreationFactory(title = "DO_NOT_USE", label = "DO_NOT_USE", resourceShapes = { OslcConstants.PATH_RESOURCE_SHAPES
            + "/" + SimulinkAdaptorConstants.PATH_ENABLEBLOCKRESOURCE }, resourceTypes = {
    ...
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public Response createEnableBlockResource(@PathParam("serviceProviderId") final String serviceProviderId,
            final EnableBlockResource aEnableBlockResource) throws IOException, ServletException {
        try {
            EnableBlockResource newEnableBlockResource = SimulinkAdaptorManager.createEnableBlockResource(
                    httpServletRequest, aEnableBlockResource, serviceProviderId);
            httpServletResponse.setHeader("ETag",
                    SimulinkAdaptorManager.getETagFromEnableBlockResource(newEnableBlockResource));
            return Response.created(newEnableBlockResource.getAbout()).entity(aEnableBlockResource).build();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
        }
