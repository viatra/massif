...
/**
 * Pattern-specific match representation of the hu.bme.mit.massif.models.simulink.util.simpleOutPortToOutPortConnection pattern,
...
public abstract class SimpleOutPortToOutPortConnectionMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("connection".equals(parameterName) ) {
    	this.fConnection = (hu.bme.mit.massif.simulink.SingleConnection) newValue;
    	return true;
    }
    return false;
  }
