...
<%
    List<SimulinkModelResource> resources = (List<SimulinkModelResource>) request.getAttribute("resources");
...
<head>
    ...
    <title>SimulinkModelResource Query</title>
    <%--
...
End of user code 
        ...
        <% for (SimulinkModelResource aSimulinkModelResource : resources) { %>
