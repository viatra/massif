...
/**
 * Generated pattern matcher API of the hu.bme.mit.transima.models.simulink.util.portConnection pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link PortConnectionMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see PortConnectionQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class PortConnectionMatcher extends BaseMatcher<PortConnectionMatch> {
  /**
   * @return the singleton instance of the query specification of this pattern
   * @throws IncQueryException if the pattern definition could not be loaded
   * 
   */
  public static IQuerySpecification<PortConnectionMatcher> querySpecification() throws IncQueryException {
   ...
   * 
   */
  public static PortConnectionMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    PortConnectionMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new PortConnectionMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(PortConnectionMatcher.class);
   ...
   */
  @Deprecated
  public PortConnectionMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public PortConnectionMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a PortConnectionMatch object.
   * 
   */
  public Collection<PortConnectionMatch> getAllMatches(final OutPort pOutP, final InPort pInP, final SingleConnection pPc) {
   ...
   * @param pInP the fixed value of pattern parameter inP, or null if not bound.
   * @param pPc the fixed value of pattern parameter pc, or null if not bound.
   * @return a match represented as a PortConnectionMatch object, or null if no match is found.
   * 
   */
  public PortConnectionMatch getOneArbitraryMatch(final OutPort pOutP, final InPort pInP, final SingleConnection pPc) {
   ...
   * 
   */
  public void forEachMatch(final OutPort pOutP, final InPort pInP, final SingleConnection pPc, final IMatchProcessor<? super PortConnectionMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final OutPort pOutP, final InPort pInP, final SingleConnection pPc, final IMatchProcessor<? super PortConnectionMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<PortConnectionMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final OutPort pOutP, final InPort pInP, final SingleConnection pPc) {
   ...
   * 
   */
  public PortConnectionMatch newMatch(final OutPort pOutP, final InPort pInP, final SingleConnection pPc) {
    return PortConnectionMatch.newMatch(pOutP, pInP, pPc);
   ...
   * 
   */
  public Set<OutPort> getAllValuesOfoutP(final PortConnectionMatch partialMatch) {
   ...
   * 
   */
  public Set<InPort> getAllValuesOfinP(final PortConnectionMatch partialMatch) {
   ...
   * 
   */
  public Set<SingleConnection> getAllValuesOfpc(final PortConnectionMatch partialMatch) {
  ...
  @Override
  protected PortConnectionMatch tupleToMatch(final Tuple t) {
    try {
      return PortConnectionMatch.newMatch((hu.bme.mit.transima.Simulink.OutPort) t.get(POSITION_OUTP), (hu.bme.mit.transima.Simulink.InPort) t.get(POSITION_INP), (hu.bme.mit.transima.Simulink.SingleConnection) t.get(POSITION_PC));
  ...
  @Override
  protected PortConnectionMatch arrayToMatch(final Object[] match) {
    try {
      return PortConnectionMatch.newMatch((hu.bme.mit.transima.Simulink.OutPort) match[POSITION_OUTP], (hu.bme.mit.transima.Simulink.InPort) match[POSITION_INP], (hu.bme.mit.transima.Simulink.SingleConnection) match[POSITION_PC]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected PortConnectionMatch arrayToMatchMutable(final Object[] match) {
    try {
      return PortConnectionMatch.newMutableMatch((hu.bme.mit.transima.Simulink.OutPort) match[POSITION_OUTP], (hu.bme.mit.transima.Simulink.InPort) match[POSITION_INP], (hu.bme.mit.transima.Simulink.SingleConnection) match[POSITION_PC]);
    } catch(ClassCastException e) {
      LOGGER.error("Element(s) in array not properly typed!",e);
      return null;
    }
