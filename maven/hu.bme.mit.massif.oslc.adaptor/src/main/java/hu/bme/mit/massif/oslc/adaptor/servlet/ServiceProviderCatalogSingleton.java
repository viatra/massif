...
import hu.bme.mit.massif.oslc.adaptor.ServiceProviderInfo;
...
public class ServiceProviderCatalogSingleton {
    ...
    static {
        try {
            ...
            serviceProviderCatalog.setTitle("Simulink-OSLC-Provider");
            serviceProviderCatalog.setDescription("Provides services to enable browsing a simulink model.");
            serviceProviderCatalog.setPublisher(new Publisher("Fault Tolerant Systems Research Group", "ftsrg"));
            serviceProviderCatalog.getPublisher().setIcon(
                    new URI("https://inf.mit.bme.hu/sites/default/files/ftsrg_logo_black.png"));
    ...
    private static URI constructServiceProviderURI(final String serviceProviderId) {
        ...
        String instanceURI = "/simu/{serviceProviderId}";
    ...
    public static ServiceProvider registerServiceProvider(final HttpServletRequest httpServletRequest,
            final ServiceProvider serviceProvider, final String serviceProviderId) throws URISyntaxException {
        synchronized (serviceProviders) {
    ...
    public static void deregisterServiceProvider(final String serviceProviderId) {
        synchronized (serviceProviders) {
            final ServiceProvider deregisteredServiceProvider = serviceProviders
                    .remove(serviceProviderIdentifier(serviceProviderId));
    ...
    protected static void initServiceProviders(HttpServletRequest httpServletRequest) {
        try {
            ...
            ServiceProviderInfo[] serviceProviderInfos = SimulinkAdaptorManager
                    .getServiceProviderInfos(httpServletRequest);
            ...
            for (ServiceProviderInfo serviceProviderInfo : serviceProviderInfos) {
                ...
                if (!serviceProviders.containsKey(identifier)) {
                    ...
                    String title = "SimulinkProvider: " + serviceProviderName + "(" + identifier + ")";
                    String description = "Provide services to get informations about a running Simulink instance.: "
                            + serviceProviderName + "(" + identifier + ")";
                    Publisher publisher = new Publisher("Fault Tolerant Systems Research Group", "ftsrg");
                    Map<String, Object> parameterMap = new HashMap<String, Object>();
                    parameterMap.put("serviceProviderId", serviceProviderInfo.serviceProviderId);
                    final ServiceProvider aServiceProvider = SimulinkAdaptorServiceProviderFactory
                            .createServiceProvider(basePath, title, description, publisher, parameterMap);
