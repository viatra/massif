...
@Path("/simu/{serviceProviderId}/simulinkElementResources")
public class SimulinkElementResourceService {
    @Context
    ...
    public SimulinkElementResourceService() {
        super();
    }
    ...
    public SimulinkElementResource[] getSimulinkElementResources(
        ...
        final List<SimulinkElementResource> resources = SimulinkAdaptorManager.getSimulinkElementResources(
                httpServletRequest, serviceProviderId, page, limit);
        return resources.toArray(new SimulinkElementResource[resources.size()]);
    ...
    public Response getSimulinkElementResourcesAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
        ...
        if (resources != null) {
            ...
            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/simulinkelementresourcecollection_html.jsp");
    ...
    @Path("{simElem}")
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public SimulinkElementResource getSimulinkElementResource(
            @PathParam("serviceProviderId") final String serviceProviderId, @PathParam("simElem") final String simElem)
            throws IOException, ServletException, URISyntaxException {
        // Start of user code (MUST_FILL_IN) getResource_init
        // End of user code

        final SimulinkElementResource aSimulinkElementResource = SimulinkAdaptorManager.getSimulinkElementResource(
                httpServletRequest, serviceProviderId, simElem);

        if (aSimulinkElementResource != null) {
    ...
    @Path("{simElem}")
    @Produces({ MediaType.TEXT_HTML })
    public Response getSimulinkElementResourceAsHtml(@PathParam("serviceProviderId") final String serviceProviderId,
            @PathParam("simElem") final String simElem) throws ServletException, IOException, URISyntaxException {
        ...
        if (aSimulinkElementResource != null) {
            httpServletRequest.setAttribute("aSimulinkElementResource", aSimulinkElementResource);
            // Start of user code getResourceAsHTML_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest
                    .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/simulinkelementresource_html.jsp");
    ...
    public void simulinkElementResourceSelector(@QueryParam("terms") final String terms,
        ...
        try {
            ...
            if (terms != null) {
                ...
                final List<SimulinkElementResource> resources = SimulinkAdaptorManager.searchSimulinkElementResources(
                        httpServletRequest, serviceProviderId, terms);
                if (resources != null) {
                    httpServletRequest.setAttribute("resources", resources);
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/simulinkelementresourcefilteredcollection_json.jsp");
                ...
                try {
                    RequestDispatcher rd = httpServletRequest
                            .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/simulinkelementresourceselector_html.jsp");
    ...
    public void simulinkElementResourceCreatorAsHtml(@PathParam("serviceProviderId") final String serviceProviderId)
            throws IOException, ServletException {
        ...
        RequestDispatcher rd = httpServletRequest
                .getRequestDispatcher("/hu/bme/mit/simulink/oslc/adaptor/simulinkelementresourcecreator_html.jsp");
    ...
    public void createSimulinkElementResourceFromHtml(@PathParam("serviceProviderId") final String serviceProviderId) {
        try {
            SimulinkElementResource aSimulinkElementResource = new SimulinkElementResource();
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aSimulinkElementResource.setName(paramValues[0]);
            ...
            if (paramValues != null) {
                if (paramValues.length == 1) {
                    if (paramValues[0].length() != 0)
                        aSimulinkElementResource.setSimulinkRef(paramValues[0]);
                    // else, there is an empty value for that parameter, and
                    // hence ignore since the parameter is not actually set.
                }
            ...
            final SimulinkElementResource newSimulinkElementResource = SimulinkAdaptorManager
                    .createSimulinkElementResource(httpServletRequest, aSimulinkElementResource, serviceProviderId);

            httpServletRequest.setAttribute("newResource", newSimulinkElementResource);
            httpServletRequest.setAttribute("newResourceUri", newSimulinkElementResource.getAbout().toString());

            // Send back to the form a small JSON response
            httpServletResponse.setContentType("application/json");
            httpServletResponse.setStatus(Status.CREATED.getStatusCode());
            httpServletResponse.addHeader("Location", newSimulinkElementResource.getAbout().toString());
            PrintWriter out = httpServletResponse.getWriter();
            out.print("{" + "\"resource\" : \"" + newSimulinkElementResource.getAbout().toString() + "\"}");
            out.close();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
    ...
    @OslcCreationFactory(title = "DO_NOT_USE", label = "DO_NOT_USE", resourceShapes = { OslcConstants.PATH_RESOURCE_SHAPES
            + "/" + SimulinkAdaptorConstants.PATH_SIMULINKELEMENTRESOURCE }, resourceTypes = {
    ...
    @Produces({ OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
    public Response createSimulinkElementResource(@PathParam("serviceProviderId") final String serviceProviderId,
            final SimulinkElementResource aSimulinkElementResource) throws IOException, ServletException {
        try {
            SimulinkElementResource newSimulinkElementResource = SimulinkAdaptorManager.createSimulinkElementResource(
                    httpServletRequest, aSimulinkElementResource, serviceProviderId);
            httpServletResponse.setHeader("ETag",
                    SimulinkAdaptorManager.getETagFromSimulinkElementResource(newSimulinkElementResource));
            return Response.created(newSimulinkElementResource.getAbout()).entity(aSimulinkElementResource).build();
        } catch (Exception e) {
            e.printStackTrace();
            throw new WebApplicationException(e);
        }
