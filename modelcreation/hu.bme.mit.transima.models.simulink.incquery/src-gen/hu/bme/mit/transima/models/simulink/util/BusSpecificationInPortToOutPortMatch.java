...
/**
 * Pattern-specific match representation of the hu.bme.mit.transima.models.simulink.util.busSpecificationInPortToOutPort pattern,
...
public abstract class BusSpecificationInPortToOutPortMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("inportOfBS".equals(parameterName) ) {
    	this.fInportOfBS = (hu.bme.mit.transima.Simulink.InPort) newValue;
    	return true;
    }
    if ("outPortOfBS".equals(parameterName) ) {
    	this.fOutPortOfBS = (hu.bme.mit.transima.Simulink.OutPort) newValue;
    	return true;
    }
    return false;
