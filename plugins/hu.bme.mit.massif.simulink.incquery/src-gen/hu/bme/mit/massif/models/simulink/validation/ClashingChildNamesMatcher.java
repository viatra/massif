...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.validation.clashingChildNames pattern,
...
public class ClashingChildNamesMatcher extends BaseMatcher<ClashingChildNamesMatch> {
  ...
  protected ClashingChildNamesMatch tupleToMatch(final Tuple t) {
    try {
    	return ClashingChildNamesMatch.newMatch((hu.bme.mit.massif.simulink.SimulinkElement) t.get(POSITION_PARENT), (hu.bme.mit.massif.simulink.SimulinkElement) t.get(POSITION_CHILD));
  ...
  protected ClashingChildNamesMatch arrayToMatch(final Object[] match) {
    try {
    	return ClashingChildNamesMatch.newMatch((hu.bme.mit.massif.simulink.SimulinkElement) match[POSITION_PARENT], (hu.bme.mit.massif.simulink.SimulinkElement) match[POSITION_CHILD]);
    } catch(ClassCastException e) {
  ...
  protected ClashingChildNamesMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return ClashingChildNamesMatch.newMutableMatch((hu.bme.mit.massif.simulink.SimulinkElement) match[POSITION_PARENT], (hu.bme.mit.massif.simulink.SimulinkElement) match[POSITION_CHILD]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
