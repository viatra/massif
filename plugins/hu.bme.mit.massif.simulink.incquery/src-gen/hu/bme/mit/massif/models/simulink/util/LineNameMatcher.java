...
/**
 * Generated pattern matcher API of the hu.bme.mit.massif.models.simulink.util.lineName pattern,
...
public class LineNameMatcher extends BaseMatcher<LineNameMatch> {
  ...
  public Set<Connection> getAllValuesOfconn(final String pName) {
    return rawAccumulateAllValuesOfconn(new Object[]{
    null, 
    pName
    });
  }
  ...
  protected LineNameMatch tupleToMatch(final Tuple t) {
    try {
    	return LineNameMatch.newMatch((hu.bme.mit.massif.simulink.Connection) t.get(POSITION_CONN), (java.lang.String) t.get(POSITION_NAME));
  ...
  protected LineNameMatch arrayToMatch(final Object[] match) {
    try {
    	return LineNameMatch.newMatch((hu.bme.mit.massif.simulink.Connection) match[POSITION_CONN], (java.lang.String) match[POSITION_NAME]);
    } catch(ClassCastException e) {
  ...
  protected LineNameMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return LineNameMatch.newMutableMatch((hu.bme.mit.massif.simulink.Connection) match[POSITION_CONN], (java.lang.String) match[POSITION_NAME]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
