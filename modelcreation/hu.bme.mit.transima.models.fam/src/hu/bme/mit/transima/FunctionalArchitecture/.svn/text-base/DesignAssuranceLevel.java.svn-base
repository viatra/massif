 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * This EEnum represents the possible values of design assurance levels.
 * <!-- end-model-doc -->
 * @see hu.bme.mit.transima.FunctionalArchitecture.FunctionalArchitectureModelPackage#getDesignAssuranceLevel()
 * @model
 * @generated
 */
